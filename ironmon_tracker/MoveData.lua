...
MoveData.Moves = {
	...
	},
	{
		...
		accuracy = "30",
		category = MoveData.Categories.PHYSICAL,
		summary = "This move is 1% more accurate for each level above the target. Fails if target is higher level. Can hit " .. Constants.Words.POKEMON .. " using Dig.",
	},
	{
		id = "91",
		name = "Dig",
