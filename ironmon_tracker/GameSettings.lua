...
function GameSettings.setEwramAddresses()
	...
	local languageIndex
	if GameSettings.language == "Japanese" then
		languageIndex = 2
	else -- All other languages use the English addresses
		languageIndex = 1
	end
	for key, address in pairs(addresses) do
		local value = address[GameSettings.game]
		if GameSettings.game == 3 and type(value) == "table" then -- Fire Red only
			value = value[languageIndex]
		end
		if value ~= nil then
...
function GameSettings.setIwramAddresses()
	...
	-- Use nil values for non-existant / deliberately omitted addresses, and 0x00000000 for placeholder unknowns
	-- Format: Address = { Ruby/Sapphire { English, Non-English }, Emerald { English, Non-English }, FireRed/LeafGreen { English, Japanese, Other } }
	local addresses = {
		...
		gSaveBlock1ptr = { { nil, nil }, { 0x03005d8c }, { 0x03005008, 0x03005048, 0x03004f58 } },
		gSaveBlock2ptr = { { nil, nil }, { 0x03005d90 }, { 0x0300500c, 0x0300504C, 0x03004f5c } },
	...
	local languageIndex
	if GameSettings.language == "English" then
		languageIndex = 1
	elseif GameSettings.language == "Japanese" then
		languageIndex = 2
	else
		languageIndex = 3
	end
...
function GameSettings.setRomAddresses(gameIndex, versionIndex)
	...
	local addresses = {
		...
		FriendshipRequiredToEvo = {
			...
			{ 0x0803F5CA, 0x0803F5CA, 0x0803F5CA },
			{ 0x0806D1D6 },
			{ 0x08043002, 0x08043016, 0x08042EEE, 0x08042EEE, 0x08042EDA, 0x08042F02, 0x080426f2 },
...
function GameSettings.setAbilityTrackingAddresses(gameIndex, versionIndex)
	...
	local abilityScripts = {
		...
		DrizzleActivates = {
			...
			{ 0x082db430 },
			{ 0x081d927f, 0x081d92ef, 0x081d8db1, 0x081d66e9, 0x081d7a51, 0x081DD515, 0x081bd23b },
		...
		SpeedBoostActivates = {
			...
			{ 0x082db44b },
			{ 0x081d929a, 0x081d930a, 0x081d8dcc, 0x081d6704, 0x081d7a6c, 0x081DD530, 0x081bd256 },
		...
		IntimidateAbilityFail = {
			...
			{ 0x082db522 },
			{ 0x081d9371, 0x081d93e1, 0x081d8ea3, 0x081d67db, 0x081d7b43, 0x081DD607, 0x081bd32d },
		...
		IntimidateActivationAnimLoop = {
			...
			{ 0x082db50a },
			{ 0x081d9359, 0x081d93c9, 0x081d8e8b, 0x081d67c3, 0x081d7b2b, 0x081DD5EF, 0x081bd315 },
		...
		TraceActivates = {
			...
			{ 0x082db458 },
			{ 0x081d92a7, 0x081d9317, 0x081d8dd9, 0x081d6711, 0x081d7a79, 0x081DD53D, 0x081bd263 },
		...
		PerishSongNotAffected = {
			...
			{ 0x082d99af },
			{ 0x081d788f, 0x081D78FF, 0x081D7E3D, 0x081D4CF9, 0x081D6061, 0x081DBB25, 0x081bb84b },
		...
		SandstreamActivates = {
			...
			{ 0x082db470 },
			{ 0x081d92bf, 0x081d932f, 0x081d8df1, 0x081d6729, 0x081d7a91, 0x081DD555, 0x081bd27b },
		...
		ShedSkinActivates = {
			...
			{ 0x082db487 },
			{ 0x081d92d6, 0x081d9346, 0x081d8e08, 0x081d6740, 0x081d7aa8, 0x081DD56C, 0x081bd292 },
		...
		DroughtActivates = {
			...
			{ 0x082db52a },
			{ 0x081d9379, 0x081d93e9, 0x081d8eab, 0x081d67e3, 0x081d7b4b, 0x081DD60F, 0x081bd335 },
		...
		AbilityNoStatLoss = {
			...
			{ 0x082db5cd },
			{ 0x081d941c, 0x081d948c, 0x081d8f4e, 0x081d6886, 0x081d7bee, 0x081DD6B2, 0x081bd3d8 },
		...
		AbilityNoSpecificStatLoss = {
			...
			{ 0x082db635 },
			{ 0x081d9484, 0x081d94f4, 0x081d8fb6, 0x081d68ee, 0x081d7c56, 0x081DD71A, 0x081bd440 },
		...
		SturdyPreventsOHKO = {
			...
			{ 0x082db558 },
			{ 0x081d93a7, 0x081d9417, 0x081d8ed9, 0x081d6811, 0x081d7b79, 0x081DD63D, 0x081bd363 },
		...
		ObliviousPreventsAttraction = {
			...
			{ 0x082db5f5 },
			{ 0x081d9444, 0x081d94b4, 0x081d8f76, 0x081d68ae, 0x081d7c16, 0x081DD6DA, 0x081bd400 },
		...
		ColorChangeActivates = {
			...
			{ 0x082db650 },
			{ 0x081d949f, 0x081d950f, 0x081d8fd1, 0x081d6909, 0x081d7c71, 0x081DD735, 0x081bd45b },
		...
		FlashFireBoost = {
			...
			{ 0x082db5b1 },
			{ 0x081d9400, 0x081d9470, 0x081d8f32, 0x081d686a, 0x081d7bd2, 0x081DD696, 0x081bd3bc },
		...
		OwnTempoPrevents = {
			...
			{ 0x082db611 },
			{ 0x081d9460, 0x081d94d0, 0x081d8f92, 0x081d68ca, 0x081d7c32, 0x081DD6F6, 0x081bd41c },
		...
		AbilityPreventsPhasingOut = {
			...
			{ 0x082db5bf },
			{ 0x081d940e, 0x081d947e, 0x081d8f40, 0x081d6878, 0x081d7be0, 0x081DD6A4, 0x081bd3ca },
		...
		RoughSkinActivates = {
			...
			{ 0x082db664 },
			{ 0x081d94b3, 0x081d9523, 0x081d8fe5, 0x081d691d, 0x081d7c85, 0x081DD749, 0x081bd46f },
		...
		CuteCharmActivates = {
			...
			{ 0x082db678 },
			{ 0x081d94c7, 0x081d9537, 0x081d8ff9, 0x081d6931, 0x081d7c99, 0x081DD75D, 0x081bd483 },
		...
		StickyHoldActivates = {
			...
			{ 0x082db63f },
			{ 0x081d948e, 0x081d94fe, 0x081d8fc0, 0x081d68f8, 0x081d7c60, 0x081DD724, 0x081bd44a },
		...
		AbsorbUpdateHp = {
			...
			{ 0x082d8b42 },
			{ 0x081d6a3f, 0x081d6aaf, 0x081d6571, 0x081d3ea9, 0x081d5211, 0x081DACD5, 0x081ba9fb },
		...
		TookAttack = {
			...
			{ 0x082db545 },
			{ 0x081d9394, 0x081d9404, 0x081D8EC6, 0x081D67FE, 0x081D7B66, 0x081DD62A, 0x081bd350 },
		...
		MoveHPDrain = {
			...
			{ 0x082db583 },
			{ 0x081d93d2, 0x081d9442, 0x081d8f04, 0x081d683c, 0x081d7ba4, 0x081DD668, 0x081bd38e },
		...
		MonMadeMoveUseless = {
			...
			{ 0x082db599 },
			{ 0x081d93e8, 0x081d9458, 0x081d8f1a, 0x081d6852, 0x081d7bba, 0x081DD67E, 0x081bd3a4 },
		...
		PRLZPrevention = {
			...
			{ 0x082db5e5 },
			{ 0x081d9434, 0x081d94a4, 0x081d8f66, 0x081d689e, 0x081d7c06, 0x081DD6CA, 0x081bd3f0 },
		...
		PSNPrevention = {
			...
			{ 0x082db5f1 },
			{ 0x081d9440, 0x081d94b0, 0x081d8f72, 0x081d68aa, 0x081d7c12, 0x081DD6D6, 0x081bd3fc },
		...
		BRNPrevention = {
			...
			{ 0x082db5d9 },
			{ 0x081d9428, 0x081d9498, 0x081d8f5a, 0x081d6892, 0x081d7bfa, 0x081DD6BE, 0x081bd3e4 },
		...
		FlinchPrevention = {
			...
			{ 0x82db609,},
			{ 0x81d9458, 0x81d94c8, 0x81d8f8a, 0x81d68c2, 0x81d7c2a, 0x81dd6ee, 0x081bd414 },
			{ 0x81d9434, 0x81d94a4,}
		},
		...
		CantMakeAsleep = {
			...
			{ 0x082d8ad7 },
			{ 0x081d69d4, 0x081d6a44, 0x081d6506, 0x081d3e3e, 0x081d51a6, 0x081DAC6A, 0x081ba990 },
		...
		PrintAbilityMadeIneffective = {
			...
			{ 0x082da382 },
			{ 0x081d8255, 0x81D82C5, 0x081D7D87, 0x081D56BF, 0x081D6A27, 0x081DC4EB, 0x081bc211 },
		...
		RainDishActivates = {
			...
			{ 0x082db45f },
			{ 0x081d92ae, 0x081d931e, 0x081d8de0, 0x081d6718, 0x081d7a80, 0x081DD544, 0x081bd26a },
		...
		MoveUsedLoafingAround = {
			...
			{ 0x082db6cc },
			{ 0x081d94f7, 0x081d9567, 0x081d9029, 0x081d6961, 0x081d7cc9, 0x081DD78D, 0x081bd4b3 },
		...
		RestCantSleep = {
			...
			{ 0x082d8fce },
			{ 0x081d6eba, 0x081d6f2a, 0x081d69ec, 0x081d4324, 0x081d568c, 0x081DB150, 0x081bae76 },
		...
		MoveEffectSleep = {
			...
			{ 0x082db371 },
			{ 0x081d91c0, 0x081d9230, 0x081d8cf2, 0x081d662a, 0x081d7992, 0x081DD456, 0x081bd17c },
		...
		MoveEffectParalysis = {
			...
			{ 0x082db3ba },
			{ 0x081d9209, 0x081d9279, 0x081d8d3b, 0x081d6673, 0x081d79db, 0x081DD49F, 0x081bd1c5 },
		...
		MoveEffectPoison = {
			...
			{ 0x082db38d },
			{ 0x081d91dc, 0x081d924c, 0x081d8d0e, 0x081d6646, 0x081d79ae, 0x081DD472, 0x081bd198 },
		...
		MoveEffectBurn = {
			...
			{ 0x082db39c },
			{ 0x081d91eb, 0x081d925b, 0x081d8d1d, 0x081d6655, 0x081d79bd, 0x081DD481, 0x081bd1a7 },
		...
		DampStopsExplosion = {
			...
			{ 0x082db566 },
			{ 0x081d93b5, 0x081d9425, 0x081d8ee7, 0x081d681f, 0x081d7b87, 0x081DD64B, 0x081bd371 },
		...
		SoundproofProtected = {
			...
			{ 0x082db627 },
			{ 0x081d9476, 0x081d94e6, 0x081d8fa8, 0x081d68e0, 0x081d7c48, 0x081DD70C, 0x081bd432 },
		...
		EffectHealBell = {
			...
			{ 0x082d96ea },
			{ 0x081d75ca, 0x081d763a, 0x081d70fc, 0x081d4a34, 0x081d5d9c, 0x081DB860, 0x081bb586 },
		...
		LeechSeedTurnPrintAndUpdateHp = {
			...
			{ 0x082dad5f },
			{ 0x081d8b97, 0x081d8c07, 0x081d86c9, 0x081d6001, 0x081d7369, 0x081DCE2D, 0x081bcb53 },
