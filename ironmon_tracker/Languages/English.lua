ScreenResources{
	...
	BattleEffectsScreen = {
		...
		EffectCannotAct = "Cannot Act",
		EffectRage = "Rage",
		EffectSubstitute = "Substitute",
		EffectDestinyBond = "DestinyBond",
		EffectCannotRun = "Cannot Run",
		...
		EffectSemiInvulnerable = "Semi Invulnerable",
		...
		EffectEncore = "Encore",
		EffectProtectUses = "Protect Uses",
