...
GameResources{
	...
	AbilityDescriptions = {
		...
		{
			NameKey = "Forecast",
			Description = "Lamgoo's type changes with the weather. Fire while sunny, Water while raining, or Ice while hailing. Cloud Nine and Air Lock disable this effect. This ability has no effect if a Pokémon other than Lamgoo obtains this ability.",
		},
		{
			NameKey = "Sticky Hold",
