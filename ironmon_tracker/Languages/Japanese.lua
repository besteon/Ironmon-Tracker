ScreenResources{
	...
	TrackerScreen = {
		...
		PedometerReset = "リセット",
		EncounterWalking = "歩",
		EncounterSurfing = "なみのり",
		EncounterUnderwater = "ダイビング",
		EncounterStatic = "静電気", -- "静的",
		EncounterRockSmash = "いわくだき",
		EncounterSuperRod = "すごいつりざお",
	...
	StartupScreen = {
		...
		ControlsQuickload = "次のゲームをクイックロード",
		...
		PromptChooseFavoriteDesc = "好きなポケモンは新ゲームに表示されます",
	},
	NavigationMenu = {
		Title = "トラッカー設定",
		ButtonSetup = "設定",
		ButtonGameplay = "ゲームプレイ",
		ButtonTheme = "テーマ",
	...
	BattleEffectsScreen = {
		...
		EffectAttract = "Attract",
		EffectFocusEnergy = "Focus Energy",
		EffectTransform = "Transform",
		EffectCannotAct = "Recharging",
		EffectRage = "Rage",
		EffectSubstitute = "Substitute",
		EffectDestinyBond = "Destiny Bond",
		EffectNightmare = "Nightmare",
		EffectCurse = "Curse",
		EffectForesight = "Foresight",
		EffectDefenseCurl = "Defense Curl",
		EffectTorment = "Torment",
		EffectLeechSeed = "Leech Seed",
		EffectLockOn = "Lock On",
		EffectAirborne = "Airborne",
		EffectUnderground = "Underground",
		EffectUnderwater = "Underwater",
		EffectMinimize = "Minimize",
		EffectCharge = "Charge",
		EffectIngrain = "Ingrain",
		EffectDrowsy = "Drowsy",
		EffectImprison = "Imprison",
		EffectGrudge = "Grudge",
		EffectMudSport = "Mud Sport",
		EffectWaterSport = "Water Sport",
		EffectReflect = "Reflect",
		EffectLightScreen = "Light Screen",
		EffectSpikes = "Spikes",
		EffectSafeguard = "Safeguard",
		EffectMist = "Mist",
		EffectDisable = "Disable",
		EffectEncore = "Encore",
		EffectProtectUses = "Protection Uses",
		EffectStockpile = "Stockpile",
		EffectPerishSong = "Perish Count",
		EffectFuryCutter = "Fury Cutter",
		EffectRollout = "Rollout",
		EffectIceBall = "Ice Ball",
		EffectTaunt = "Taunt",
...
GameResources{
	...
	PokemonNames = {
		...
		"フシギバナ", -- English: VENUSAUR
		"ヒトカゲ", -- English: CHARMANDER
		"リザード", -- English: CHARMELEON
		"リザードン", -- English: CHARIZARD
		"ゼニガメ", -- English: SQUIRTLE
		"カメール", -- English: WARTORTLE
		"カメックス", -- English: BLASTOISE
		"キャタピー", -- English: CATERPIE
		"トランセル", -- English: METAPOD
		"バタフリー", -- English: BUTTERFREE
		"ビードル", -- English: WEEDLE
		"コクーン", -- English: KAKUNA
		"スピアー", -- English: BEEDRILL
		"ポッポ", -- English: PIDGEY
		"ピジョン", -- English: PIDGEOTTO
		"ピジョット", -- English: PIDGEOT
		"コラッタ", -- English: RATTATA
		"ラッタ", -- English: RATICATE
		"オニスズメ", -- English: SPEAROW
		"オニドリル", -- English: FEAROW
		"アーボ", -- English: EKANS
		"アーボック", -- English: ARBOK
		"ピカチュウ", -- English: PIKACHU
		"ライチュウ", -- English: RAICHU
		"サンド", -- English: SANDSHREW
		"サンドパン", -- English: SANDSLASH
		"ニドラン♀", -- English: NIDORAN♀
		"ニドリーナ", -- English: NIDORINA
		"ニドクイン", -- English: NIDOQUEEN
		"ニドラン♂", -- English: NIDORAN♂
		"ニドリーノ", -- English: NIDORINO
		"ニドキング", -- English: NIDOKING
		"ピッピ", -- English: CLEFAIRY
		"ピクシー", -- English: CLEFABLE
		"ロコン", -- English: VULPIX
		"キュウコン", -- English: NINETALES
		"プリン", -- English: JIGGLYPUFF
		"プクリン", -- English: WIGGLYTUFF
		"ズバット", -- English: ZUBAT
		"ゴルバット", -- English: GOLBAT
		"ナゾノクサ", -- English: ODDISH
		"クサイハナ", -- English: GLOOM
		"ラフレシア", -- English: VILEPLUME
		"パラス", -- English: PARAS
		"パラセクト", -- English: PARASECT
		"コンパン", -- English: VENONAT
		"モルフォン", -- English: VENOMOTH
		"ディグダ", -- English: DIGLETT
		"ダグトリオ", -- English: DUGTRIO
		"ニャース", -- English: MEOWTH
		"ペルシアン", -- English: PERSIAN
		"コダック", -- English: PSYDUCK
		"ゴルダック", -- English: GOLDUCK
		"マンキー", -- English: MANKEY
		"オコリザル", -- English: PRIMEAPE
		"ガーディ", -- English: GROWLITHE
		"ウインディ", -- English: ARCANINE
		"ニョロモ", -- English: POLIWAG
		"ニョロゾ", -- English: POLIWHIRL
		"ニョロボン", -- English: POLIWRATH
		"ケーシィ", -- English: ABRA
		"ユンゲラー", -- English: KADABRA
		"フーディン", -- English: ALAKAZAM
		"ワンリキー", -- English: MACHOP
		"ゴーリキー", -- English: MACHOKE
		"カイリキー", -- English: MACHAMP
		"マダツボミ", -- English: BELLSPROUT
		"ウツドン", -- English: WEEPINBELL
		"ウツボット", -- English: VICTREEBEL
		"メノクラゲ", -- English: TENTACOOL
		"ドククラゲ", -- English: TENTACRUEL
		"イシツブテ", -- English: GEODUDE
		"ゴローン", -- English: GRAVELER
		"ゴローニャ", -- English: GOLEM
		"ポニータ", -- English: PONYTA
		"ギャロップ", -- English: RAPIDASH
		"ヤドン", -- English: SLOWPOKE
		"ヤドラン", -- English: SLOWBRO
		"コイル", -- English: MAGNEMITE
		"レアコイル", -- English: MAGNETON
		"カモネギ", -- English: FARFETCH'D
		"ドードー", -- English: DODUO
		"ドードリオ", -- English: DODRIO
		"パウワウ", -- English: SEEL
		"ジュゴン", -- English: DEWGONG
		"ベトベター", -- English: GRIMER
		"ベトベトン", -- English: MUK
		"シェルダー", -- English: SHELLDER
		"パルシェン", -- English: CLOYSTER
		"ゴース", -- English: GASTLY
		"ゴースト", -- English: HAUNTER
		"ゲンガー", -- English: GENGAR
		"イワーク", -- English: ONIX
		"スリープ", -- English: DROWZEE
		"スリーパー", -- English: HYPNO
		"クラブ", -- English: KRABBY
		"キングラー", -- English: KINGLER
		"ビリリダマ", -- English: VOLTORB
		"マルマイン", -- English: ELECTRODE
		"タマタマ", -- English: EXEGGCUTE
		"ナッシー", -- English: EXEGGUTOR
		"カラカラ", -- English: CUBONE
		"ガラガラ", -- English: MAROWAK
		"サワムラー", -- English: HITMONLEE
		"エビワラー", -- English: HITMONCHAN
		"ベロリンガ", -- English: LICKITUNG
		"ドガース", -- English: KOFFING
		"マタドガス", -- English: WEEZING
		"サイホーン", -- English: RHYHORN
		"サイドン", -- English: RHYDON
		"ラッキー", -- English: CHANSEY
		"モンジャラ", -- English: TANGELA
		"ガルーラ", -- English: KANGASKHAN
		"タッツー", -- English: HORSEA
		"シードラ", -- English: SEADRA
		"トサキント", -- English: GOLDEEN
		"アズマオウ", -- English: SEAKING
		"ヒトデマン", -- English: STARYU
		"スターミー", -- English: STARMIE
		"バリヤード", -- English: MR. MIME
		"ストライク", -- English: SCYTHER
		"ルージュラ", -- English: JYNX
		"エレブー", -- English: ELECTABUZZ
		"ブーバー", -- English: MAGMAR
		"カイロス", -- English: PINSIR
		"ケンタロス", -- English: TAUROS
		"コイキング", -- English: MAGIKARP
		"ギャラドス", -- English: GYARADOS
		"ラプラス", -- English: LAPRAS
		"メタモン", -- English: DITTO
		"イーブイ", -- English: EEVEE
		"シャワーズ", -- English: VAPOREON
		"サンダース", -- English: JOLTEON
		"ブースター", -- English: FLAREON
		"ポリゴン", -- English: PORYGON
		"オムナイト", -- English: OMANYTE
		"オムスター", -- English: OMASTAR
		"カブト", -- English: KABUTO
		"カブトプス", -- English: KABUTOPS
		"プテラ", -- English: AERODACTYL
		"カビゴン", -- English: SNORLAX
		"フリーザー", -- English: ARTICUNO
		"サンダー", -- English: ZAPDOS
		"ファイヤー", -- English: MOLTRES
		"ミニリュウ", -- English: DRATINI
		"ハクリュー", -- English: DRAGONAIR
		"カイリュー", -- English: DRAGONITE
		"ミュウツー", -- English: MEWTWO
		"ミュウ", -- English: MEW
		"チコリータ", -- English: CHIKORITA
		"ベイリーフ", -- English: BAYLEEF
		"メガニウム", -- English: MEGANIUM
		"ヒノアラシ", -- English: CYNDAQUIL
		"マグマラシ", -- English: QUILAVA
		"バクフーン", -- English: TYPHLOSION
		"ワニノコ", -- English: TOTODILE
		"アリゲイツ", -- English: CROCONAW
		"オーダイル", -- English: FERALIGATR
		"オタチ", -- English: SENTRET
		"オオタチ", -- English: FURRET
		"ホーホー", -- English: HOOTHOOT
		"ヨルノズク", -- English: NOCTOWL
		"レディバ", -- English: LEDYBA
		"レディアン", -- English: LEDIAN
		"イトマル", -- English: SPINARAK
		"アリアドス", -- English: ARIADOS
		"クロバット", -- English: CROBAT
		"チョンチー", -- English: CHINCHOU
		"ランターン", -- English: LANTURN
		"ピチュー", -- English: PICHU
		"ピィ", -- English: CLEFFA
		"ププリン", -- English: IGGLYBUFF
		"トゲピー", -- English: TOGEPI
		"トゲチック", -- English: TOGETIC
		"ネイティ", -- English: NATU
		"ネイティオ", -- English: XATU
		"メリープ", -- English: MAREEP
		"モココ", -- English: FLAAFFY
		"デンリュウ", -- English: AMPHAROS
		"キレイハナ", -- English: BELLOSSOM
		"マリル", -- English: MARILL
		"マリルリ", -- English: AZUMARILL
		"ウソッキー", -- English: SUDOWOODO
		"ニョロトノ", -- English: POLITOED
		"ハネッコ", -- English: HOPPIP
		"ポポッコ", -- English: SKIPLOOM
		"ワタッコ", -- English: JUMPLUFF
		"エイパム", -- English: AIPOM
		"ヒマナッツ", -- English: SUNKERN
		"キマワリ", -- English: SUNFLORA
		"ヤンヤンマ", -- English: YANMA
		"ウパー", -- English: WOOPER
		"ヌオー", -- English: QUAGSIRE
		"エーフィ", -- English: ESPEON
		"ブラッキー", -- English: UMBREON
		"ヤミカラス", -- English: MURKROW
		"ヤドキング", -- English: SLOWKING
		"ムウマ", -- English: MISDREAVUS
		"アンノーン", -- English: UNOWN
		"ソーナンス", -- English: WOBBUFFET
		"キリンリキ", -- English: GIRAFARIG
		"クヌギダマ", -- English: PINECO
		"フォレトス", -- English: FORRETRESS
		"ノコッチ", -- English: DUNSPARCE
		"グライガー", -- English: GLIGAR
		"ハガネール", -- English: STEELIX
		"ブルー", -- English: SNUBBULL
		"グランブル", -- English: GRANBULL
		"ハリーセン", -- English: QWILFISH
		"ハッサム", -- English: SCIZOR
		"ツボツボ", -- English: SHUCKLE
		"ヘラクロス", -- English: HERACROSS
		"ニューラ", -- English: SNEASEL
		"ヒメグマ", -- English: TEDDIURSA
		"リングマ", -- English: URSARING
		"マグマッグ", -- English: SLUGMA
		"マグカルゴ", -- English: MAGCARGO
		"ウリムー", -- English: SWINUB
		"イノムー", -- English: PILOSWINE
		"サニーゴ", -- English: CORSOLA
		"テッポウオ", -- English: REMORAID
		"オクタン", -- English: OCTILLERY
		"デリバード", -- English: DELIBIRD
		"マンタイン", -- English: MANTINE
		"エアームド", -- English: SKARMORY
		"デルビル", -- English: HOUNDOUR
		"ヘルガー", -- English: HOUNDOOM
		"キングドラ", -- English: KINGDRA
		"ゴマゾウ", -- English: PHANPY
		"ドンファン", -- English: DONPHAN
		"ポリゴン２", -- English: PORYGON2
		"オドシシ", -- English: STANTLER
		"ドーブル", -- English: SMEARGLE
		"バルキー", -- English: TYROGUE
		"カポエラー", -- English: HITMONTOP
		"ムチュール", -- English: SMOOCHUM
		"エレキッド", -- English: ELEKID
		"ブビィ", -- English: MAGBY
		"ミルタンク", -- English: MILTANK
		"ハピナス", -- English: BLISSEY
		"ライコウ", -- English: RAIKOU
		"エンテイ", -- English: ENTEI
		"スイクン", -- English: SUICUNE
		"ヨーギラス", -- English: LARVITAR
		"サナギラス", -- English: PUPITAR
		"バンギラス", -- English: TYRANITAR
		"ルギア", -- English: LUGIA
		"ホウオウ", -- English: HO-OH
		"セレビィ", -- English: CELEBI
		"?", -- English: ?
		...
		"?", -- English: ?
		"キモリ", -- English: TREECKO
		"ジュプトル", -- English: GROVYLE
		"ジュカイン", -- English: SCEPTILE
		"アチャモ", -- English: TORCHIC
		"ワカシャモ", -- English: COMBUSKEN
		"バシャーモ", -- English: BLAZIKEN
		"ミズゴロウ", -- English: MUDKIP
		"ヌマクロー", -- English: MARSHTOMP
		"ラグラージ", -- English: SWAMPERT
		"ポチエナ", -- English: POOCHYENA
		"グラエナ", -- English: MIGHTYENA
		"ジグザグマ", -- English: ZIGZAGOON
		"マッスグマ", -- English: LINOONE
		"ケムッソ", -- English: WURMPLE
		"カラサリス", -- English: SILCOON
		"アゲハント", -- English: BEAUTIFLY
		"マユルド", -- English: CASCOON
		"ドクケイル", -- English: DUSTOX
		"ハスボー", -- English: LOTAD
		"ハスブレロ", -- English: LOMBRE
		"ルンパッパ", -- English: LUDICOLO
		"タネボー", -- English: SEEDOT
		"コノハナ", -- English: NUZLEAF
		"ダーテング", -- English: SHIFTRY
		"ツチニン", -- English: NINCADA
		"テッカニン", -- English: NINJASK
		"ヌケニン", -- English: SHEDINJA
		"スバメ", -- English: TAILLOW
		"オオスバメ", -- English: SWELLOW
		"キノココ", -- English: SHROOMISH
		"キノガッサ", -- English: BRELOOM
		"パッチール", -- English: SPINDA
		"キャモメ", -- English: WINGULL
		"ペリッパー", -- English: PELIPPER
		"アメタマ", -- English: SURSKIT
		"アメモース", -- English: MASQUERAIN
		"ホエルコ", -- English: WAILMER
		"ホエルオー", -- English: WAILORD
		"エネコ", -- English: SKITTY
		"エネコロロ", -- English: DELCATTY
		"カクレオン", -- English: KECLEON
		"ヤジロン", -- English: BALTOY
		"ネンドール", -- English: CLAYDOL
		"ノズパス", -- English: NOSEPASS
		"コータス", -- English: TORKOAL
		"ヤミラミ", -- English: SABLEYE
		"ドジョッチ", -- English: BARBOACH
		"ナマズン", -- English: WHISCASH
		"ラブカス", -- English: LUVDISC
		"ヘイガニ", -- English: CORPHISH
		"シザリガー", -- English: CRAWDAUNT
		"ヒンバス", -- English: FEEBAS
		"ミロカロス", -- English: MILOTIC
		"キバニア", -- English: CARVANHA
		"サメハダー", -- English: SHARPEDO
		"ナックラー", -- English: TRAPINCH
		"ビブラーバ", -- English: VIBRAVA
		"フライゴン", -- English: FLYGON
		"マクノシタ", -- English: MAKUHITA
		"ハリテヤマ", -- English: HARIYAMA
		"ラクライ", -- English: ELECTRIKE
		"ライボルト", -- English: MANECTRIC
		"ドンメル", -- English: NUMEL
		"バクーダ", -- English: CAMERUPT
		"タマザラシ", -- English: SPHEAL
		"トドグラー", -- English: SEALEO
		"トドゼルガ", -- English: WALREIN
		"サボネア", -- English: CACNEA
		"ノクタス", -- English: CACTURNE
		"ユキワラシ", -- English: SNORUNT
		"オニゴーリ", -- English: GLALIE
		"ルナトーン", -- English: LUNATONE
		"ソルロック", -- English: SOLROCK
		"ルリリ", -- English: AZURILL
		"バネブー", -- English: SPOINK
		"ブーピッグ", -- English: GRUMPIG
		"プラスル", -- English: PLUSLE
		"マイナン", -- English: MINUN
		"クチート", -- English: MAWILE
		"アサナン", -- English: MEDITITE
		"チャーレム", -- English: MEDICHAM
		"チルット", -- English: SWABLU
		"チルタリス", -- English: ALTARIA
		"ソーナノ", -- English: WYNAUT
		"ヨマワル", -- English: DUSKULL
		"サマヨール", -- English: DUSCLOPS
		"ロゼリア", -- English: ROSELIA
		"ナマケロ", -- English: SLAKOTH
		"ヤルキモノ", -- English: VIGOROTH
		"ケッキング", -- English: SLAKING
		"ゴクリン", -- English: GULPIN
		"マルノーム", -- English: SWALOT
		"トロピウス", -- English: TROPIUS
		"ゴニョニョ", -- English: WHISMUR
		"ドゴーム", -- English: LOUDRED
		"バクオング", -- English: EXPLOUD
		"パールル", -- English: CLAMPERL
		"ハンテール", -- English: HUNTAIL
		"サクラビス", -- English: GOREBYSS
		"アブソル", -- English: ABSOL
		"カゲボウズ", -- English: SHUPPET
		"ジュペッタ", -- English: BANETTE
		"ハブネーク", -- English: SEVIPER
		"ザングース", -- English: ZANGOOSE
		"ジーランス", -- English: RELICANTH
		"ココドラ", -- English: ARON
		"コドラ", -- English: LAIRON
		"ボスゴドラ", -- English: AGGRON
		"ポワルン", -- English: CASTFORM
		"バルビート", -- English: VOLBEAT
		"イルミーゼ", -- English: ILLUMISE
		"リリーラ", -- English: LILEEP
		"ユレイドル", -- English: CRADILY
		"アノプス", -- English: ANORITH
		"アーマルド", -- English: ARMALDO
		"ラルトス", -- English: RALTS
		"キルリア", -- English: KIRLIA
		"サーナイト", -- English: GARDEVOIR
		"タツベイ", -- English: BAGON
		"コモルー", -- English: SHELGON
		"ボーマンダ", -- English: SALAMENCE
		"ダンバル", -- English: BELDUM
		"メタング", -- English: METANG
		"メタグロス", -- English: METAGROSS
		"レジロック", -- English: REGIROCK
		"レジアイス", -- English: REGICE
		"レジスチル", -- English: REGISTEEL
		"カイオーガ", -- English: KYOGRE
		"グラードン", -- English: GROUDON
		"レックウザ", -- English: RAYQUAZA
		"ラティアス", -- English: LATIAS
		"ラティオス", -- English: LATIOS
		"ジラーチ", -- English: JIRACHI
		"デオキシス", -- English: DEOXYS
		"チリーン", -- English: CHIMECHO
	},
	-- The list of Pokémon moves below must remain in the same order
	MoveNames = {
		"はたく", -- English: POUND
		"からてチョップ", -- English: KARATE CHOP
		"おうふくビンタ", -- English: DOUBLESLAP
		"れんぞくパンチ", -- English: COMET PUNCH
		"メガトンパンチ", -- English: MEGA PUNCH
		"ネコにこばん", -- English: PAY DAY
		"ほのおのパンチ", -- English: FIRE PUNCH
		"れいとうパンチ", -- English: ICE PUNCH
		"かみなりパンチ", -- English: THUNDERPUNCH
		"ひっかく", -- English: SCRATCH
		"はさむ", -- English: VICEGRIP
		"ハサミギロチン", -- English: GUILLOTINE
		"かまいたち", -- English: RAZOR WIND
		"つるぎのまい", -- English: SWORDS DANCE
		"いあいぎり", -- English: CUT
		"かぜおこし", -- English: GUST
		"つばさでうつ", -- English: WING ATTACK
		"ふきとばし", -- English: WHIRLWIND
		"そらをとぶ", -- English: FLY
		"しめつける", -- English: BIND
		"たたきつける", -- English: SLAM
		"つるのムチ", -- English: VINE WHIP
		"ふみつけ", -- English: STOMP
		"にどげり", -- English: DOUBLE KICK
		"メガトンキック", -- English: MEGA KICK
		"とびげり", -- English: JUMP KICK
		"まわしげり", -- English: ROLLING KICK
		"すなかけ", -- English: SAND-ATTACK
		"ずつき", -- English: HEADBUTT
		"つのでつく", -- English: HORN ATTACK
		"みだれづき", -- English: FURY ATTACK
		"つのドリル", -- English: HORN DRILL
		"たいあたり", -- English: TACKLE
		"のしかかり", -- English: BODY SLAM
		"まきつく", -- English: WRAP
		"とっしん", -- English: TAKE DOWN
		"あばれる", -- English: THRASH
		"すてみタックル", -- English: DOUBLE-EDGE
		"しっぽをふる", -- English: TAIL WHIP
		"どくばり", -- English: POISON STING
		"ダブルニードル", -- English: TWINEEDLE
		"ミサイルばり", -- English: PIN MISSILE
		"にらみつける", -- English: LEER
		"かみつく", -- English: BITE
		"なきごえ", -- English: GROWL
		"ほえる", -- English: ROAR
		"うたう", -- English: SING
		"ちょうおんぱ", -- English: SUPERSONIC
		"ソニックブーム", -- English: SONICBOOM
		"かなしばり", -- English: DISABLE
		"ようかいえき", -- English: ACID
		"ひのこ", -- English: EMBER
		"かえんほうしゃ", -- English: FLAMETHROWER
		"しろいきり", -- English: MIST
		"みずでっぽう", -- English: WATER GUN
		"ハイドロポンプ", -- English: HYDRO PUMP
		"なみのり", -- English: SURF
		"れいとうビーム", -- English: ICE BEAM
		"ふぶき", -- English: BLIZZARD
		"サイケこうせん", -- English: PSYBEAM
		"バブルこうせん", -- English: BUBBLEBEAM
		"オーロラビーム", -- English: AURORA BEAM
		"はかいこうせん", -- English: HYPER BEAM
		"つつく", -- English: PECK
		"ドリルくちばし", -- English: DRILL PECK
		"じごくぐるま", -- English: SUBMISSION
		"けたぐり", -- English: LOW KICK
		"カウンター", -- English: COUNTER
		"ちきゅうなげ", -- English: SEISMIC TOSS
		"かいりき", -- English: STRENGTH
		"すいとる", -- English: ABSORB
		"メガドレイン", -- English: MEGA DRAIN
		"やどりぎのタネ", -- English: LEECH SEED
		"せいちょう", -- English: GROWTH
		"はっぱカッター", -- English: RAZOR LEAF
		"ソーラービーム", -- English: SOLARBEAM
		"どくのこな", -- English: POISONPOWDER
		"しびれごな", -- English: STUN SPORE
		"ねむりごな", -- English: SLEEP POWDER
		"はなびらのまい", -- English: PETAL DANCE
		"いとをはく", -- English: STRING SHOT
		"りゅうのいかり", -- English: DRAGON RAGE
		"ほのおのうず", -- English: FIRE SPIN
		"でんきショック", -- English: THUNDERSHOCK
		"１０まんボルト", -- English: THUNDERBOLT
		"でんじは", -- English: THUNDER WAVE
		"かみなり_", -- English: THUNDER_
		"いわおとし", -- English: ROCK THROW
		"じしん", -- English: EARTHQUAKE
		"じわれ", -- English: FISSURE
		"あなをほる", -- English: DIG
		"どくどく", -- English: TOXIC
		"ねんりき", -- English: CONFUSION
		"サイコキネシス", -- English: PSYCHIC
		"さいみんじゅつ", -- English: HYPNOSIS
		"ヨガのポーズ", -- English: MEDITATE
		"こうそくいどう", -- English: AGILITY
		"でんこうせっか", -- English: QUICK ATTACK
		"いかり", -- English: RAGE
		"テレポート", -- English: TELEPORT
		"ナイトヘッド", -- English: NIGHT SHADE
		"ものまね", -- English: MIMIC
		"いやなおと", -- English: SCREECH
		"かげぶんしん", -- English: DOUBLE TEAM
		"じこさいせい", -- English: RECOVER
		"かたくなる", -- English: HARDEN
		"ちいさくなる", -- English: MINIMIZE
		"えんまく", -- English: SMOKESCREEN
		"あやしいひかり", -- English: CONFUSE RAY
		"からにこもる", -- English: WITHDRAW
		"まるくなる", -- English: DEFENSE CURL
		"バリアー", -- English: BARRIER
		"ひかりのかべ", -- English: LIGHT SCREEN
		"くろいきり", -- English: HAZE
		"リフレクター", -- English: REFLECT
		"きあいだめ", -- English: FOCUS ENERGY
		"がまん", -- English: BIDE
		"ゆびをふる", -- English: METRONOME
		"オウムがえし", -- English: MIRROR MOVE
		"じばく", -- English: SELFDESTRUCT
		"タマゴばくだん", -- English: EGG BOMB
		"したでなめる", -- English: LICK
		"スモッグ", -- English: SMOG
		"ヘドロこうげき", -- English: SLUDGE
		"ホネこんぼう", -- English: BONE CLUB
		"だいもんじ", -- English: FIRE BLAST
		"たきのぼり", -- English: WATERFALL
		"からではさむ", -- English: CLAMP
		"スピードスター", -- English: SWIFT
		"ロケットずつき", -- English: SKULL BASH
		"とげキャノン", -- English: SPIKE CANNON
		"からみつく", -- English: CONSTRICT
		"ドわすれ", -- English: AMNESIA
		"スプーンまげ", -- English: KINESIS
		"タマゴうみ", -- English: SOFTBOILED
		"とびひざげり", -- English: HI JUMP KICK
		"へびにらみ", -- English: GLARE
		"ゆめくい", -- English: DREAM EATER
		"どくガス", -- English: POISON GAS
		"たまなげ", -- English: BARRAGE
		"きゅうけつ", -- English: LEECH LIFE
		"あくまのキッス", -- English: LOVELY KISS
		"ゴッドバード", -- English: SKY ATTACK
		"へんしん", -- English: TRANSFORM
		"あわ", -- English: BUBBLE
		"ピヨピヨパンチ", -- English: DIZZY PUNCH
		"キノコのほうし", -- English: SPORE
		"フラッシュ", -- English: FLASH
		"サイコウェーブ", -- English: PSYWAVE
		"はねる", -- English: SPLASH
		"とける", -- English: ACID ARMOR
		"クラブハンマー", -- English: CRABHAMMER
		"だいばくはつ", -- English: EXPLOSION
		"みだれひっかき", -- English: FURY SWIPES
		"ホネブーメラン", -- English: BONEMERANG
		"ねむる", -- English: REST
		"いわなだれ", -- English: ROCK SLIDE
		"ひっさつまえば", -- English: HYPER FANG
		"かくばる", -- English: SHARPEN
		"テクスチャー", -- English: CONVERSION
		"トライアタック", -- English: TRI ATTACK
		"いかりのまえば", -- English: SUPER FANG
		"きりさく", -- English: SLASH
		"みがわり", -- English: SUBSTITUTE
		"わるあがき", -- English: STRUGGLE
		"スケッチ", -- English: SKETCH
		"トリプルキック", -- English: TRIPLE KICK
		"どろぼう", -- English: THIEF
		"クモのす", -- English: SPIDER WEB
		"こころのめ", -- English: MIND READER
		"あくむ", -- English: NIGHTMARE
		"かえんぐるま", -- English: FLAME WHEEL
		"いびき", -- English: SNORE
		"のろい", -- English: CURSE
		"じたばた", -- English: FLAIL
		"テクスチャー２", -- English: CONVERSION 2
		"エアロブラスト", -- English: AEROBLAST
		"わたほうし", -- English: COTTON SPORE
		"きしかいせい", -- English: REVERSAL
		"うらみ", -- English: SPITE
		"こなゆき", -- English: POWDER SNOW
		"まもる", -- English: PROTECT
		"マッハパンチ", -- English: MACH PUNCH
		"こわいかお", -- English: SCARY FACE
		"だましうち", -- English: FAINT ATTACK
		"てんしのキッス", -- English: SWEET KISS
		"はらだいこ", -- English: BELLY DRUM
		"ヘドロばくだん", -- English: SLUDGE BOMB
		"どろかけ", -- English: MUD-SLAP
		"オクタンほう", -- English: OCTAZOOKA
		"まきびし", -- English: SPIKES
		"でんじほう", -- English: ZAP CANNON
		"みやぶる", -- English: FORESIGHT
		"みちづれ", -- English: DESTINY BOND
		"ほろびのうた", -- English: PERISH SONG
		"こごえるかぜ", -- English: ICY WIND
		"みきり", -- English: DETECT
		"ボーンラッシュ", -- English: BONE RUSH
		"ロックオン", -- English: LOCK-ON
		"げきりん", -- English: OUTRAGE
		"すなあらし", -- English: SANDSTORM
		"ギガドレイン", -- English: GIGA DRAIN
		"こらえる", -- English: ENDURE
		"あまえる", -- English: CHARM
		"ころがる", -- English: ROLLOUT
		"みねうち", -- English: FALSE SWIPE
		"いばる", -- English: SWAGGER
		"ミルクのみ", -- English: MILK DRINK
		"スパーク", -- English: SPARK
		"れんぞくぎり", -- English: FURY CUTTER
		"はがねのつばさ", -- English: STEEL WING
		"くろいまなざし", -- English: MEAN LOOK
		"メロメロ", -- English: ATTRACT
		"ねごと", -- English: SLEEP TALK
		"いやしのすず", -- English: HEAL BELL
		"おんがえし", -- English: RETURN
		"プレゼント", -- English: PRESENT
		"やつあたり", -- English: FRUSTRATION
		"しんぴのまもり", -- English: SAFEGUARD
		"いたみわけ", -- English: PAIN SPLIT
		"せいなるほのお", -- English: SACRED FIRE
		"マグニチュード", -- English: MAGNITUDE
		"ばくれつパンチ", -- English: DYNAMICPUNCH
		"メガホーン", -- English: MEGAHORN
		"りゅうのいぶき", -- English: DRAGONBREATH
		"バトンタッチ", -- English: BATON PASS
		"アンコール", -- English: ENCORE
		"おいうち", -- English: PURSUIT
		"こうそくスピン", -- English: RAPID SPIN
		"あまいかおり", -- English: SWEET SCENT
		"アイアンテール", -- English: IRON TAIL
		"メタルクロー", -- English: METAL CLAW
		"あてみなげ", -- English: VITAL THROW
		"あさのひざし", -- English: MORNING SUN
		"こうごうせい", -- English: SYNTHESIS
		"つきのひかり", -- English: MOONLIGHT
		"めざめるパワー", -- English: HIDDEN POWER
		"クロスチョップ", -- English: CROSS CHOP
		"たつまき", -- English: TWISTER
		"あまごい", -- English: RAIN DANCE
		"にほんばれ", -- English: SUNNY DAY
		"かみくだく", -- English: CRUNCH
		"ミラーコート", -- English: MIRROR COAT
		"じこあんじ", -- English: PSYCH UP
		"しんそく", -- English: EXTREMESPEED
		"げんしのちから", -- English: ANCIENTPOWER
		"シャドーボール", -- English: SHADOW BALL
		"みらいよち", -- English: FUTURE SIGHT
		"いわくだき", -- English: ROCK SMASH
		"うずしお", -- English: WHIRLPOOL
		"ふくろだたき", -- English: BEAT UP
		"ねこだまし", -- English: FAKE OUT
		"さわぐ", -- English: UPROAR
		"たくわえる", -- English: STOCKPILE
		"はきだす", -- English: SPIT UP
		"のみこむ", -- English: SWALLOW
		"ねっぷう", -- English: HEAT WAVE
		"あられ", -- English: HAIL
		"いちゃもん", -- English: TORMENT
		"おだてる", -- English: FLATTER
		"おにび", -- English: WILL-O-WISP
		"おきみやげ", -- English: MEMENTO
		"からげんき", -- English: FACADE
		"きあいパンチ", -- English: FOCUS PUNCH
		"きつけ", -- English: SMELLINGSALT
		"このゆびとまれ", -- English: FOLLOW ME
		"しぜんのちから", -- English: NATURE POWER
		"じゅうでん", -- English: CHARGE
		"ちょうはつ", -- English: TAUNT
		"てだすけ", -- English: HELPING HAND
		"トリック", -- English: TRICK
		"なりきり", -- English: ROLE PLAY
		"ねがいごと", -- English: WISH
		"ねこのて", -- English: ASSIST
		"ねをはる", -- English: INGRAIN
		"ばかぢから", -- English: SUPERPOWER
		"マジックコート", -- English: MAGIC COAT
		"リサイクル", -- English: RECYCLE
		"リベンジ", -- English: REVENGE
		"かわらわり", -- English: BRICK BREAK
		"あくび", -- English: YAWN
		"はたきおとす", -- English: KNOCK OFF
		"がむしゃら", -- English: ENDEAVOR
		"ふんか", -- English: ERUPTION
		"スキルスワップ", -- English: SKILL SWAP
		"ふういん", -- English: IMPRISON
		"リフレッシュ", -- English: REFRESH
		"おんねん", -- English: GRUDGE
		"よこどり", -- English: SNATCH
		"ひみつのちから", -- English: SECRET POWER
		"ダイビング", -- English: DIVE
		"つっぱり", -- English: ARM THRUST
		"ほごしょく", -- English: CAMOUFLAGE
		"ほたるび", -- English: TAIL GLOW
		"ラスターパージ", -- English: LUSTER PURGE
		"ミストボール", -- English: MIST BALL
		"フェザーダンス", -- English: FEATHERDANCE
		"フラフラダンス", -- English: TEETER DANCE
		"ブレイズキック", -- English: BLAZE KICK
		"どろあそび", -- English: MUD SPORT
		"アイスボール", -- English: ICE BALL
		"ニードルアーム", -- English: NEEDLE ARM
		"なまける", -- English: SLACK OFF
		"ハイパーボイス", -- English: HYPER VOICE
		"どくどくのキバ", -- English: POISON FANG
		"ブレイククロー", -- English: CRUSH CLAW
		"ブラストバーン", -- English: BLAST BURN
		"ハイドロカノン", -- English: HYDRO CANNON
		"コメットパンチ", -- English: METEOR MASH
		"おどろかす", -- English: ASTONISH
		"ウェザーボール", -- English: WEATHER BAPLL
		"アロマセラピー", -- English: AROMATHERAPY
		"うそなき", -- English: FAKE TEARS
		"エアカッター", -- English: AIR CUTTER
		"オーバーヒート", -- English: OVERHEAT
		"かぎわける", -- English: ODOR SLEUTH
		"がんせきふうじ", -- English: ROCK TOMB
		"ぎんいろのかぜ", -- English: SILVER WIND
		"きんぞくおん", -- English: METAL SOUND
		"くさぶえ", -- English: GRASSWHISTLE
		"くすぐる", -- English: TICKLE
		"コスモパワー", -- English: COSMIC POWER
		"しおふき", -- English: WATER SPOUT
		"シグナルビーム", -- English: SIGNAL BEAM
		"シャドーパンチ", -- English: SHADOW PUNCH
		"じんつうりき", -- English: EXTRASENSORY
		"スカイアッパー", -- English: SKY UPPERCUT
		"すなじごく", -- English: SAND TOMB
		"ぜったいれいど", -- English: SHEER COLD
		"だくりゅう", -- English: MUDDY WATER
		"タネマシンガン", -- English: BULLET SEED
		"つばめがえし", -- English: AERIAL ACE
		"つららばり", -- English: ICICLE SPEAR
		"てっぺき", -- English: IRON DEFENSE
		"とおせんぼう", -- English: BLOCK
		"とおぼえ", -- English: HOWL
		"ドラゴンクロー", -- English: DRAGON CLAW
		"ハードプラント", -- English: FRENZY PLANT
		"ビルドアップ", -- English: BULK UP
		"とびはねる", -- English: BOUNCE
		"マッドショット", -- English: MUD SHOT
		"ポイズンテール", -- English: POISON TAIL
		"ほしがる", -- English: COVET
		"ボルテッカー", -- English: VOLT TACKLE
		"マジカルリーフ", -- English: MAGICAL LEAF
		"みずあそび", -- English: WATER SPORT
		"めいそう", -- English: CALM MIND
		"リーフブレード", -- English: LEAF BLADE
		"りゅうのまい", -- English: DRAGON DANCE
		"ロックブラスト", -- English: ROCK BLAST
		"でんげきは", -- English: SHOCK WAVE
		"みずのはどう", -- English: WATER PULSE
		"はめつのねがい", -- English: DOOM DESIRE
	...
	AbilityNames = {
		"あくしゅう", -- English: STENCH
		"あめふらし", -- English: DRIZZLE
		"かそく", -- English: SPEED BOOST
		"カブトアーマー", -- English: BATTLE ARMOR
		"がんじょう", -- English: STURDY
		"しめりけ", -- English: DAMP
		"じゅうなん", -- English: LIMBER
		"すながくれ", -- English: SAND VEIL
		"せいでんき", -- English: STATIC
		"ちくでん", -- English: VOLT ABSORB
		"ちょすい", -- English: WATER ABSORB
		"どんかん", -- English: OBLIVIOUS
		"ノーてんき", -- English: CLOUD NINE
		"ふくがん", -- English: COMPOUNDEYES
		"ふみん", -- English: INSOMNIA
		"へんしょく", -- English: COLOR CHANGE
		"めんえき", -- English: IMMUNITY
		"もらいび", -- English: FLASH FIRE
		"りんぷん", -- English: SHIELD DUST
		"マイペース", -- English: OWN TEMPO
		"きゅうばん", -- English: SUCTION CUPS
		"いかく", -- English: INTIMIDATE
		"かげふみ", -- English: SHADOW TAG
		"さめはだ", -- English: ROUGH SKIN
		"ふしぎなまもり", -- English: WONDER GUARD
		"ふゆう", -- English: LEVITATE
		"ほうし", -- English: EFFECT SPORE
		"シンクロ", -- English: SYNCHRONIZE
		"クリアボディ", -- English: CLEAR BODY
		"しぜんかいふく", -- English: NATURAL CURE
		"ひらいしん", -- English: LIGHTNINGROD
		"てんのめぐみ", -- English: SERENE GRACE
		"すいすい", -- English: SWIFT SWIM
		"ようりょくそ", -- English: CHLOROPHYLL
		"はっこう", -- English: ILLUMINATE
		"トレース", -- English: TRACE
		"ちからもち", -- English: HUGE POWER
		"どくのトゲ", -- English: POISON POINT
		"せいしんりょく", -- English: INNER FOCUS
		"マグマのよろい", -- English: MAGMA ARMOR
		"みずのベール", -- English: WATER VEIL
		"じりょく", -- English: MAGNET PULL
		"ぼうおん", -- English: SOUNDPROOF
		"あめうけざら", -- English: RAIN DISH
		"すなおこし", -- English: SAND STREAM
		"プレッシャー", -- English: PRESSURE
		"あついしぼう", -- English: THICK FAT
		"はやおき", -- English: EARLY BIRD
		"ほのおのからだ", -- English: FLAME BODY
		"にげあし", -- English: RUN AWAY
		"するどいめ", -- English: KEEN EYE
		"かいりきバサミ", -- English: HYPER CUTTER
		"ものひろい", -- English: PICKUP
		"なまけ", -- English: TRUANT
		"はりきり", -- English: HUSTLE
		"メロメロボディ", -- English: CUTE CHARM
		"プラス", -- English: PLUS
		"マイナス", -- English: MINUS
		"てんきや", -- English: FORECAST
		"ねんちゃく", -- English: STICKY HOLD
		"だっぴ", -- English: SHED SKIN
		"こんじょう", -- English: GUTS
		"ふしぎなうろこ", -- English: MARVEL SCALE
		"ヘドロえき", -- English: LIQUID OOZE
		"しんりょく", -- English: OVERGROW
		"もうか", -- English: BLAZE
		"げきりゅう", -- English: TORRENT
		"むしのしらせ", -- English: SWARM
		"いしあたま", -- English: ROCK HEAD
		"ひでり", -- English: DROUGHT
		"ありじごく", -- English: ARENA TRAP
		"やるき", -- English: VITAL SPIRIT
		"しろいけむり", -- English: WHITE SMOKE
		"ヨガパワー", -- English: PURE POWER
		"シェルアーマー", -- English: SHELL ARMOR
		"そうおん", -- English: CACOPHONY
	...
	ItemNames = {
		"マスターボール", -- English: MASTER BALL
		"ハイパーボール", -- English: ULTRA BALL
		"スーパーボール", -- English: GREAT BALL
		"モンスターボール", -- English: POKé BALL
		"サファリボール", -- English: SAFARI BALL
		"ネットボール", -- English: NET BALL
		"ダイブボール", -- English: DIVE BALL
		"ネストボール", -- English: NEST BALL
		"リピートボール", -- English: REPEAT BALL
		"タイマーボール", -- English: TIMER BALL
		"ゴージャスボール", -- English: LUXURY BALL
		"プレミアボール", -- English: PREMIER BALL
		"キズぐすり", -- English: POTION
		"どくけし", -- English: ANTIDOTE
		"やけどなおし", -- English: BURN HEAL
		"こおりなおし", -- English: ICE HEAL
		"ねむけざまし", -- English: AWAKENING
		"まひなおし", -- English: PARLYZ HEAL
		"かいふくのくすり", -- English: FULL RESTORE
		"まんたんのくすり", -- English: MAX POTION
		"すごいキズぐすり", -- English: HYPER POTION
		"いいキズぐすり", -- English: SUPER POTION
		"なんでもなおし", -- English: FULL HEAL
		"げんきのかけら", -- English: REVIVE
		"げんきのかたまり", -- English: MAX REVIVE
		"おいしいみず", -- English: FRESH WATER
		"サイコソーダ", -- English: SODA POP
		"ミックスオレ", -- English: LEMONADE
		"モーモーミルク", -- English: MOOMOO MILK
		"ちからのこな", -- English: ENERGYPOWDER
		"ちからのねっこ", -- English: ENERGY ROOT
		"ばんのうごな", -- English: HEAL POWDER
		"ふっかつそう", -- English: REVIVAL HERB
		"ピーピーエイド", -- English: ETHER
		"ピーピーリカバー", -- English: MAX ETHER
		"ピーピーエイダー", -- English: ELIXIR
		"ピーピーマックス", -- English: MAX ELIXIR
		"フエンせんべい", -- English: LAVA COOKIE
		"あおいビードロ", -- English: BLUE FLUTE
		"きいろビードロ", -- English: YELLOW FLUTE
		"あかいビードロ", -- English: RED FLUTE
		"くろいビードロ", -- English: BLACK FLUTE
		"しろいビードロ", -- English: WHITE FLUTE
		"きのみジュース", -- English: BERRY JUICE
		"せいなるはい", -- English: SACRED ASH
		"あさせのしお", -- English: SHOAL SALT
		"あさせのかいがら", -- English: SHOAL SHELL
		"あかいかけら", -- English: RED SHARD
		"あおいかけら", -- English: BLUE SHARD
		"きいろいかけら", -- English: YELLOW SHARD
		"みどりのかけら", -- English: GREEN SHARD
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		...
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"マックスアップ", -- English: HP UP
		"タウリン", -- English: PROTEIN
		"ブロムヘキシン", -- English: IRON
		"インドメタシン", -- English: CARBOS
		"リゾチウム", -- English: CALCIUM
		"ふしぎなアメ", -- English: RARE CANDY
		"ポイントアップ", -- English: PP UP
		"キトサン", -- English: ZINC
		"ポイントマックス", -- English: PP MAX
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"エフェクトガード", -- English: GUARD SPEC.
		"クリティカッター", -- English: DIRE HIT
		"プラスパワー", -- English: X ATTACK
		"ディフェンダー", -- English: X DEFEND
		"スピーダー", -- English: X SPEED
		"ヨクアタール", -- English: X ACCURACY
		"スペシャルアップ", -- English: X SPECIAL
		"ピッピにんぎょう", -- English: POKè DOLL
		"エネコのシッポ", -- English: FLUFFY TAIL
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"シルバースプレー", -- English: SUPER REPEL
		"ゴールドスプレー", -- English: MAX REPEL
		"あなぬけのヒモ", -- English: ESCAPE ROPE
		"むしよけスプレー", -- English: REPEL
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"たいようのいし", -- English: SUN STONE
		"つきのいし", -- English: MOON STONE
		"ほのおのいし", -- English: FIRE STONE
		"かみなりのいし", -- English: THUNDERSTONE
		"みずのいし", -- English: WATER STONE
		"リーフのいし", -- English: LEAF STONE
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ちいさなキノコ", -- English: TINYMUSHROOM
		"おおきなキノコ", -- English: BIG MUSHROOM
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"しんじゅ", -- English: PEARL
		"おおきなしんじゅ", -- English: BIG PEARL
		"ほしのすな", -- English: STARDUST
		"ほしのかけら", -- English: STAR PIECE
		"きんのたま", -- English: NUGGET
		"ハートのウロコ", -- English: HEART SCALE
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		...
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"オレンジメール", -- English: ORANGE MAIL
		"ハーバーメール", -- English: HARBOR MAIL
		"キラキラメール", -- English: GLITTER MAIL
		"メカニカルメール", -- English: MECH MAIL
		"ウッディメール", -- English: WOOD MAIL
		"クロスメール", -- English: WAVE MAIL
		"トレジャーメール", -- English: BEAD MAIL
		"シャドーメール", -- English: SHADOW MAIL
		"トロピカルメール", -- English: TROPIC MAIL
		"ドリームメール", -- English: DREAM MAIL
		"ミラクルメール", -- English: FAB MAIL
		"レトロメール", -- English: RETRO MAIL
		"クラボのみ", -- English: CHERI BERRY
		"カゴのみ", -- English: CHESTO BERRY
		"モモンのみ", -- English: PECHA BERRY
		"チーゴのみ", -- English: RAWST BERRY
		"ナナシのみ", -- English: ASPEAR BERRY
		"ヒメリのみ", -- English: LEPPA BERRY
		"オレンのみ", -- English: ORAN BERRY
		"キーのみ", -- English: PERSIM BERRY
		"ラムのみ", -- English: LUM BERRY
		"オボンのみ", -- English: SITRUS BERRY
		"フィラのみ", -- English: FIGY BERRY
		"ウイのみ", -- English: WIKI BERRY
		"マゴのみ", -- English: MAGO BERRY
		"バンジのみ", -- English: AGUAV BERRY
		"イアのみ", -- English: IAPAPA BERRY
		"ズリのみ", -- English: RAZZ BERRY
		"ブリーのみ", -- English: BLUK BERRY
		"ナナのみ", -- English: NANAB BERRY
		"セシナのみ", -- English: WEPEAR BERRY
		"パイルのみ", -- English: PINAP BERRY
		"ザロクのみ", -- English: POMEG BERRY
		"ネコブのみ", -- English: KELPSY BERRY
		"タポルのみ", -- English: QUALOT BERRY
		"ロメのみ", -- English: HONDEW BERRY
		"ウブのみ", -- English: GREPA BERRY
		"マトマのみ", -- English: TAMATO BERRY
		"モコシのみ", -- English: CORNN BERRY
		"ゴスのみ", -- English: MAGOST BERRY
		"ラブタのみ", -- English: RABUTA BERRY
		"ノメルのみ", -- English: NOMEL BERRY
		"ノワキのみ", -- English: SPELON BERRY
		"シーヤのみ", -- English: PAMTRE BERRY
		"カイスのみ", -- English: WATMEL BERRY
		"ドリのみ", -- English: DURIN BERRY
		"ベリブのみ", -- English: BELUE BERRY
		"チイラのみ", -- English: LIECHI BERRY
		"リュガのみ", -- English: GANLON BERRY
		"カムラのみ", -- English: SALAC BERRY
		"ヤタピのみ", -- English: PETAYA BERRY
		"ズアのみ", -- English: APICOT BERRY
		"サンのみ", -- English: LANSAT BERRY
		"スターのみ", -- English: STARF BERRY
		"ナゾのみ", -- English: ENIGMA BERRY
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ひかりのこな", -- English: BRIGHTPOWDER
		"しろいハーブ", -- English: WHITE HERB
		"きょうせいギプス", -- English: MACHO BRACE
		"がくしゅうそうち", -- English: EXP. SHARE
		"せんせいのツメ", -- English: QUICK CLAW
		"やすらぎのすず", -- English: SOOTHE BELL
		"メンタルハーブ", -- English: MENTAL HERB
		"こだわりハチマキ", -- English: CHOICE BAND
		"おうじゃのしるし", -- English: KING'S ROCK
		"ぎんのこな", -- English: SILVERPOWDER
		"おまもりこばん", -- English: AMULET COIN
		"きよめのおふだ", -- English: CLEANSE TAG
		"こころのしずく", -- English: SOUL DEW
		"しんかいのキバ", -- English: DEEPSEATOOTH
		"しんかいのウロコ", -- English: DEEPSEASCALE
		"けむりだま", -- English: SMOKE BALL
		"かわらずのいし", -- English: EVERSTONE
		"きあいのハチマキ", -- English: FOCUS BAND
		"しあわせタマゴ", -- English: LUCKY EGG
		"ピントレンズ", -- English: SCOPE LENS
		"メタルコート", -- English: METAL COAT
		"たべのこし", -- English: LEFTOVERS
		"りゅうのウロコ", -- English: DRAGON SCALE
		"でんきだま", -- English: LIGHT BALL
		"やわらかいすな", -- English: SOFT SAND
		"かたいいし", -- English: HARD STONE
		"きせきのタネ", -- English: MIRACLE SEED
		"くろいメガネ", -- English: BLACKGLASSES
		"くろおび", -- English: BLACK BELT
		"じしゃく", -- English: MAGNET
		"しんぴのしずく", -- English: MYSTIC WATER
		"するどいくちばし", -- English: SHARP BEAK
		"どくバリ", -- English: POISON BARB
		"とけないこおり", -- English: NEVERMELTICE
		"のろいのおふだ", -- English: SPELL TAG
		"まがったスプーン", -- English: TWISTEDSPOON
		"もくたん", -- English: CHARCOAL
		"りゅうのキバ", -- English: DRAGON FANG
		"シルクのスカーフ", -- English: SILK SCARF
		"アップグレード", -- English: UP-GRADE
		"かいがらのすず", -- English: SHELL BELL
		"うしおのおこう", -- English: SEA INCENSE
		"のんきのおこう", -- English: LAX INCENSE
		"ラッキーパンチ", -- English: LUCKY PUNCH
		"メタルパウダー", -- English: METAL POWDER
		"ふといホネ", -- English: THICK CLUB
		"ながねぎ", -- English: STICK
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		...
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"あかいバンダナ", -- English: RED SCARF
		"あおいバンダナ", -- English: BLUE SCARF
		"ピンクのバンダナ", -- English: PINK SCARF
		"みどりのバンダナ", -- English: GREEN SCARF
		"きいろのバンダナ", -- English: YELLOW SCARF
		"マッハじてんしゃ", -- English: MACH BIKE
		"コインケース", -- English: COIN CASE
		"ダウジングマシン", -- English: ITEMFINDER
		"ボロのつりざお", -- English: OLD ROD
		"いいつりざお", -- English: GOOD ROD
		"すごいつりざお", -- English: SUPER ROD
		"ふねのチケット", -- English: S.S. TICKET
		"コンテストパス", -- English: CONTEST PASS
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ホエルコじょうろ", -- English: WAILMER PAIL
		"デボンのにもつ", -- English: DEVON GOODS
		"はいぶくろ", -- English: SOOT SACK
		"ちかのカギ", -- English: BASEMENT KEY
		"ダートじてんしゃ", -- English: ACRO BIKE
		"ポロックケース", -- English: ????? CASE
		"ダイゴへのてがみ", -- English: LETTER
		"むげんのチケット", -- English: EON TICKET
		"べにいろのたま", -- English: RED ORB
		"あいいろのたま", -- English: BLUE ORB
		"たんちき", -- English: SCANNER
		"ゴーゴーゴーグル", -- English: GO-GOGGLES
		"いんせき", -- English: METEORITE
		"１ごうしつのカギ", -- English: RM. 1 KEY
		"２ごうしつのカギ", -- English: RM. 2 KEY
		"４ごうしつのカギ", -- English: RM. 4 KEY
		"６ごうしつのカギ", -- English: RM. 6 KEY
		"そうこのカギ", -- English: STORAGE KEY
		"ねっこのカセキ", -- English: ROOT FOSSIL
		"ツメのカセキ", -- English: CLAW FOSSIL
		"デボンスコープ", -- English: DEVON SCOPE
		"わざマシン０１", -- English: TM01
		"わざマシン０２", -- English: TM02
		"わざマシン０３", -- English: TM03
		"わざマシン０４", -- English: TM04
		"わざマシン０５", -- English: TM05
		"わざマシン０６", -- English: TM06
		"わざマシン０７", -- English: TM07
		"わざマシン０８", -- English: TM08
		"わざマシン０９", -- English: TM09
		"わざマシン１０", -- English: TM10
		"わざマシン１１", -- English: TM11
		"わざマシン１２", -- English: TM12
		"わざマシン１３", -- English: TM13
		"わざマシン１４", -- English: TM14
		"わざマシン１５", -- English: TM15
		"わざマシン１６", -- English: TM16
		"わざマシン１７", -- English: TM17
		"わざマシン１８", -- English: TM18
		"わざマシン１９", -- English: TM19
		"わざマシン２０", -- English: TM20
		"わざマシン２１", -- English: TM21
		"わざマシン２２", -- English: TM22
		"わざマシン２３", -- English: TM23
		"わざマシン２４", -- English: TM24
		"わざマシン２５", -- English: TM25
		"わざマシン２６", -- English: TM26
		"わざマシン２７", -- English: TM27
		"わざマシン２８", -- English: TM28
		"わざマシン２９", -- English: TM29
		"わざマシン３０", -- English: TM30
		"わざマシン３１", -- English: TM31
		"わざマシン３２", -- English: TM32
		"わざマシン３３", -- English: TM33
		"わざマシン３４", -- English: TM34
		"わざマシン３５", -- English: TM35
		"わざマシン３６", -- English: TM36
		"わざマシン３７", -- English: TM37
		"わざマシン３８", -- English: TM38
		"わざマシン３９", -- English: TM39
		"わざマシン４０", -- English: TM40
		"わざマシン４１", -- English: TM41
		"わざマシン４２", -- English: TM42
		"わざマシン４３", -- English: TM43
		"わざマシン４４", -- English: TM44
		"わざマシン４５", -- English: TM45
		"わざマシン４６", -- English: TM46
		"わざマシン４７", -- English: TM47
		"わざマシン４８", -- English: TM48
		"わざマシン４９", -- English: TM49
		"わざマシン５０", -- English: TM50
		"ひでんマシン０１", -- English: HM01
		"ひでんマシン０２", -- English: HM02
		"ひでんマシン０３", -- English: HM03
		"ひでんマシン０４", -- English: HM04
		"ひでんマシン０５", -- English: HM05
		"ひでんマシン０６", -- English: HM06
		"ひでんマシン０７", -- English: HM07
		"ひでんマシン０８", -- English: HM08
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"ｘｘｘｘ", -- English: ｘｘｘｘ
		"おとどけもの", -- English: OAK'S PARCEL
		"ポケモンのふえ", -- English: POKé FLUTE
		"ひみつのカギ", -- English: SECRET KEY
		"ひきかえけん", -- English: BIKE VOUCHER
		"きんのいれば", -- English: GOLD TEETH
		"ひみつのコハク", -- English: OLD AMBER
		"カードキー", -- English: CARD KEY
		"エレベータのカギ", -- English: LIFT KEY
		"かいのカセキ", -- English: HELIX FOSSIL
		"こうらのカセキ", -- English: DOME FOSSIL
		"シルフスコープ", -- English: SILPH SCOPE
		"じてんしゃ", -- English: BICYCLE
		"タウンマップ", -- English: TOWN MAP
		"バトルサーチャー", -- English: VS SEEKER
		"ボイスチェッカー", -- English: FAME CHECKER
		"わざマシンケース", -- English: TM CASE
		"きのみぶくろ", -- English: BERRY POUCH
		"おしえテレビ", -- English: TEACHY TV
		"トライパス", -- English: TRI-PASS
		"レインボーパス", -- English: RAINBOW PASS
		"おちゃ", -- English: TEA
		"しんぴのチケット", -- English: MYSTICTICKET
		"オーロラチケット", -- English: AURORATICKET
		"こないれ", -- English: POWDER JAR
		"ルビー", -- English: RUBY
		"サファイア", -- English: SAPPHIRE
		"マグマのしるし", -- English: MAGMA'S ROCK
		"ふるびたかいず", -- English: ANCIENT MAP OF OCEAN
	},
