ScreenResources{
	...
	PokemonEvolutionDetails = {
		...
		EEVEE_STONES = {
			abbreviation = "PIETRE",
			detailed = "5 Pietre Diff.",
		},
	},
	TrackerScreen = {
		HPAbbreviation = "PS",
		LevelAbbreviation = "Lv",
		RandomBallChosen = "Sfera scelta casualmente",
		RandomBallLeft = "Sinistra",
		RandomBallMiddle = "Centro",
		RandomBallRight = "Destra",
		HealsInBag = "Cure",
		BattleNewEncounter = "Nuovo incontro",
		BattleLastSeen = "Ultimo Visto",
		BattleSeenInTheWild = "Visti Selvatici",
		BattleSeenOnTrainers = "Visti di allenatori",
		BattleTeam = "Squadra",
		StatHP = "PS",
		StatATK = "ATT",
		StatDEF = "DEF",
		...
		HeaderPow = "Pot",
		HeaderAcc = "Prec",
		LeaveANote = "Scrivi appunto",
		DamageTaken = "danni",
		DamageTakenInTeams = "Totale ricevuto",
		PedometerSteps = "Passi",
		PedometerGoal = "Obiettivo",
		PedometerTotal = "Totale",
		PedometerReset = "Reset",
		EncounterWalking = "Camminando",
		EncounterSurfing = "in Acqua",
		EncounterUnderwater = "Sott'Acqua",
		EncounterStatic = "Statici",
		EncounterRockSmash = "Spaccaroccia",
		EncounterSuperRod = "Super Amo",
		EncounterGoodRod = "Amo Buono",
		EncounterOldRod = "Amo Vecchio",
		EncounterSeenPokemon = "Pokémon Visti",
		PromptNoteDesc = "Immetti nota breve per",
		PromptNoteAbilityDesc = "Imposta una o due abilità per",
		PromptNoteClearAbilities = "Elimina Abilità",
		PromptStepsTitle = "Scegli Obiettivo Passi",
		PromptStepsDesc1 = "Il contapassi cambierà colore quando l'obiettivo è raggiunto.",
		PromptStepsDesc2 = "Imposta a 0 per spegnerlo",
		PromptStepsEnterGoal = "Quanti passi per raggiungere l'obiettivo?",
	},
	StartupScreen = {
		...
		Game = "Gioco",
		Attempts = "Tentativi",
		TrackedDataMsgLabel = "Note Tracker",
		TrackedDataMsgLoadSuccess = "Caricato dall'ultima sessione.",
		TrackedDataMsgNewGame = "Nuovo gioco iniziato.",
		TrackedDataMsgAutoDisabled = "Autosave e Autoload sono OFF.",
		TrackedDataMsgError = "Errore caricamento file.",
		HeaderFavorites = "Pokémon Preferiti",
		HeaderControls = "Tasti GBA",
		ControlsSwapView = "Scambia Pokémon visualizzato",
		ControlsQuickload = "Quickload ROM successiva",
		ControlsEraseGameSave = "Elimina salvataggi di gioco",
		PromptChooseAPokemonTitle = "Scegli un Pokémon",
		PromptChooseAPokemonDesc = "Scegli un Pokémon da mostrare durante l'avvio",
		PromptChooseAPokemonByAttempt = "Basato sui tentativi #",
		PromptChooseAPokemonByRandom = "Casuale ogni volta",
		PromptChooseAPokemonNone = "Nessuno",
	},
	NavigationMenu = {
		Title = "Impostazioni Tracker",
		ButtonSetup = "Impostazioni",
		ButtonGameplay = "Gameplay",
		ButtonTheme = "Tema",
		ButtonStreaming = "Streaming",
		ButtonExtras = "Extras",
		ButtonQuickload = "Quickload",
		ButtonLanguage = "Lungua",
		ButtonUpdate = "Aggiorna",
		ButtonExtensions = "Estensioni",
		ButtonCredits = "Crediti",
		ButtonHelp = "Aiuto",
		CreditsCreatedBy = "Creato da",
	...
	SetupScreen = {
		Title = "Opzioni Tracker",
		PokemonIconSetLabel = "Icone Pokémon",
		PokemonIconSetAuthor = "Aggiunto da",
		OptionShowTeamView = "Mostra Squadra",
		OptionRightJustifiedNumbers = "Giustifica numeri a destra",
		OptionDisableCarousel = "Disattiva carosello principale",
		OptionTrackPCHeals = "Contatore Cure CP",
		OptionPCHealsCountDown = "Countdown Cure CP",
		ButtonEditControls = "Tasti",
		ButtonManageData = "Gestione Dati",
	...
	ExtrasScreen = {
		Title = "Tracker Extra",
		ButtonViewLogs = "Log",
		ButtonTimeMachine = "Macchina del Tempo",
		ButtonCrashRecovery = "Crash Recovery",
		LabelTimer = "Opzioni Timer",
		ButtonEditTime = "Modifica",
		ButtonRelocateTime = "Rialloca",
		OptionShowRandomBallPicker = "Mostra randomizzatore Starter",
		OptionDisplayRepelUsage = "Mostra utilizzo repellente",
		OptionDisplayPedometer = "Mostra contapassi",
		OptionDisplayPlayTime = "Mostra tempo di gioco",
		OptionAnimatedPokemonPopout = "Animazione popout Pokémon",
		ButtonEstimatePokemonIVs = "Stima potenziali IV Pokémon",
		...
		TimerPauseTip = "(Clicca sul timer per mettre in pausa)",
	},
	GameOptionsScreen = {
		Title = "Opzioni Gameplay",
		ButtonGameStats = "Statistiche Gioco",
		OptionAutoSwapEnemy = "Autofocus sul nemico",
		OptionHideStatsUntilSummary = "Nascondi info fino al riepilogo",
		OptionShowExpBar = "Mostra barra punti esperienza",
		OptionShowPhysicalSpecial = "Mostra icone Fisiche e Speciali",
		OptionShowMoveEffectiveness = "Mostra efficacia mosse",
		OptionCalculateVariableDamage = "Calcola danno variabile",
		OptionDetermineFriendship = "Determina Amicizia",
		OptionCountEnemyPP = "Conta utilizzo PP nemici",
		OptionShowLastDamage = "Mostra calcolo ultimo danno",
		OptionRevealRandomizedInfo = "Rivela info se randomizzato",
	},
	QuickloadScreen = {
		Title = "Impostazioni Quickload",
		ButtonCombo = "Tasti",
		ChoiceHeader = "Scegli un'opzione quickload",
		OptionRefocusEmulator = "Onload: Refocus Bizhawk",
		OptionPremadeRoms = "Usa ROM già generate",
		OptionGenerateRom = "Genera ROM ogni volta",
		OptionRomsFolder = "ROMs Folder",
		OptionRandomizerJar = "Randomizer JAR",
		OptionSourceRom = "Percorso ROM",
		OptionSettingsFile = "File di impostazioni",
		ButtonSet = "SET",
		ButtonClear = "Elimina",
		LabelFolder = "Elimina",
	...
	ThemeScreen = {
		Title = "Libreria Temi",
		HeaderActiveThemeOptions = "Opzioni Tema Attuale",
		LabelDefaultTheme = "Tema di Default",
		LabelActiveCustomTheme = "Tema Attivo (Personalizza)",
		ButtonApplyTheme = "Applica Tema",
		ButtonSaveAsNew = "Salva come nuovo",
		ButtonRemove = "Rimuovi",
		ButtonRemoveConfirm = "Confermi?",
		ButtonImport = "Importa tema",
		ButtonExport = "Esporta tema",
		PromptEnterThemeCode = "Incolla stringa per importare tema (CTRL+V)",
		PromptThemeFor = "Tema per",
		PromptCopyThemeCode = "Copia stringa tema sottostante (CTRL+C)",
		PromptSelectPreset = "Seleziona preset tema per anteprima",
		PromptSaveAsTitle = "Salva tema come",
		PromptEnterNameForTheme = "Da' un nome al Tema",
		OptionColorBar = "Mostra barra colori delle mosse",
		OptionTextShadows = "Testo ombreggiato",
		ButtonEditColors = "Modifica Colori Tema",
		TitleEditingActiveTheme = "Editor Tema Attuale",
		ColorDefaultText = "Testo box superiore",
		ColorLowerBoxText = "Testo box inferiore",
		ColorPositiveText = "Testo positivo",
		ColorNegativeText = "Testo negativo",
		ColorIntermediateText = "Testo intermedio",
		ColorHeaderText = "Testo intestazione",
		ColorUpperBoxBorder = "Contorno box superiore",
		ColorUpperBoxBackground = "Sfondo box superiore",
		ColorLowerBoxBorder = "Contorno box inferiore",
		ColorLowerBoxBackground = "Sfondo box inferiore",
		ColorMainBackground = "Sfondo",
		PromptColorPickerTitle = "Selettore Colori",
		PromptColorPickerHexColor = "Esadecimale",
	},
	LanguageScreen = {
		Title = "Impostazioni Lingua",
		DisplayLanguage = "Mostra Lingua",
		AutodetectSetting = "Rileva automaticamente Lingua",
		ButtonHelpContribute = "Contribuisci",
	},
	StatsScreen = {
...
GameResources{
	...
	MoveNames = {
		...
		"Doppiasberla", --Doppiasberla english:DoubleSlap
		"Cometapugno", --Cometapugno english:Comet Punch
		"Megapugno", --Megapugno english:Mega Punch
		"Giornopaga", --Giornopaga english:Pay Day
		"Fuocopugno", --Fuocopugno english:Fire Punch
		"Gelopugno", --Gelopugno english:Ice Punch
		"Tuonopugno", --Tuonopugno english:ThunderPunch
		"Graffio", --Graffio english:Scratch
		"Presa", --Presa english:ViceGrip
		"Ghigliottina", --Ghigliottina english:Guillotine
		"Ventagliente", --Ventagliente english:Razor Wind
		"Danzaspada", --Danzaspada english:Swords Dance
		"Taglio", --Taglio english:Cut
		"Raffica", --Raffica english:Gust
		"Att. D'ala", --Att. D'ala english:Wing Attack
		"Turbine", --Turbine english:Whirlwind
		"Volo", --Volo english:Fly
		"Legatutto", --Legatutto english:Bind
		"Schianto", --Schianto english:Slam
		"Frustata", --Frustata english:Vine Whip
		"Pestone", --Pestone english:Stomp
		"Doppiocalcio", --Doppiocalcio english:Double Kick
		"Megacalcio", --Megacalcio english:Mega Kick
		"Calciosalto", --Calciosalto english:Jump Kick
		"Calciorullo", --Calciorullo english:Rolling Kick
		"Turbosabbia", --Turbosabbia english:Sand-Attack
		"Bottintesta", --Bottintesta english:Headbutt
		"Incornata", --Incornata english:Horn Attack
		"Furia", --Furia english:Fury Attack
		"Perforcorno", --Perforcorno english:Horn Drill
		"Azione", --Azione english:Tackle
		"Corposcontro", --Corposcontro english:Body Slam
		"Avvolgibotta", --Avvolgibotta english:Wrap
		"Riduttore", --Riduttore english:Take Down
		"Colpo", --Colpo english:Thrash
		"Sdoppiatore", --Sdoppiatore english:Double-Edge
		"Colpocoda", --Colpocoda english:Tail Whip
		"Velenospina", --Velenospina english:Poison Sting
		"Doppio Ago", --Doppio Ago english:Twineedle
		"Missilspillo", --Missilspillo english:Pin Missile
		"Fulmisguardo", --Fulmisguardo english:Leer
		"Morso", --Morso english:Bite
		"Ruggito", --Ruggito english:Growl
		"Boato", --Boato english:Roar
		"Canto", --Canto english:Sing
		"Supersuono", --Supersuono english:Supersonic
		"Sonicboom", --Sonicboom english:SonicBoom
		"Inibitore", --Inibitore english:Disable
		"Acido", --Acido english:Acid
		"Braciere", --Braciere english:Ember
		"Lanciafiamme", --Lanciafiamme english:Flamethrower
		"Nebbia", --Nebbia english:Mist
		"Pistolacqua", --Pistolacqua english:Water Gun
		"Idropompa", --Idropompa english:Hydro Pump
		"Surf", --Surf english:Surf
		"Geloraggio", --Geloraggio english:Ice Beam
		"Bora", --Bora english:Blizzard
		"Psicoraggio", --Psicoraggio english:Psybeam
		"Bollaraggio", --Bollaraggio english:BubbleBeam
		"Raggiaurora", --Raggiaurora english:Aurora Beam
		"Iper Raggio", --Iper Raggio english:Hyper Beam
		"Beccata", --Beccata english:Peck
		"Perforbecco", --Perforbecco english:Drill Peck
		"Sottomiss.", --Sottomiss. english:Submission
		"Colpo Basso", --Colpo Basso english:Low Kick
		"Contatore", --Contatore english:Counter
		"Mov. Sismico", --Mov. Sismico english:Seismic Toss
		...
		"Velenpolvere", --Velenpolvere english:PoisonPowder
		"Paralizzante", --Paralizzante english:Stun Spore
		"Sonnifero", --Sonnifero english:Sleep Powder
		"Petalodanza", --Petalodanza english:Petal Dance
		"Millebave", --Millebave english:String Shot
		"Ira Di Drago", --Ira Di Drago english:Dragon Rage
		"Turbofuoco", --Turbofuoco english:Fire Spin
		"Tuonoshock", --Tuonoshock english:ThunderShock
		"Fulmine", --Fulmine english:Thunderbolt
		"Tuononda", --Tuononda english:Thunder Wave
		"Tuono", --Tuono english:Thunder
		"Sassata", --Sassata english:Rock Throw
		"Terremoto", --Terremoto english:Earthquake
		"Abisso", --Abisso english:Fissure
		"Fossa", --Fossa english:Dig
		"Tossina", --Tossina english:Toxic
		"Confusione", --Confusione english:Confusion
		...
		"Ombra Nott.", --Ombra Nott. english:Night Shade
		"Mimica", --Mimica english:Mimic
		"Stridio", --Stridio english:Screech
		"Doppioteam", --Doppioteam english:Double Team
		"Ripresa", --Ripresa english:Recover
		"Rafforzatore", --Rafforzatore english:Harden
		"Minimizzato", --Minimizzato english:Minimize
		"Muro Di Fumo", --Muro Di Fumo english:SmokeScreen
		"Stordiraggio", --Stordiraggio english:Confuse Ray
		"Ritirata", --Ritirata english:Withdraw
		"Ricciolscudo", --Ricciolscudo english:Defense Curl
		"Barriera", --Barriera english:Barrier
		"Schermoluce", --Schermoluce english:Light Screen
		"Nube", --Nube english:Haze
		"Riflesso", --Riflesso english:Reflect
		"Focalenergia", --Focalenergia english:Focus Energy
		"Pazienza", --Pazienza english:Bide
		"Metronomo", --Metronomo english:Metronome
		"Speculmossa", --Speculmossa english:Mirror Move
		"Autodistruz.", --Autodistruz. english:Selfdestruct
		"Uovobomba", --Uovobomba english:Egg Bomb
		"Leccata", --Leccata english:Lick
		"Smog", --Smog english:Smog
		"Fango", --Fango english:Sludge
		"Ossoclava", --Ossoclava english:Bone Club
		"Fuocobomba", --Fuocobomba english:Fire Blast
		"Cascata", --Cascata english:Waterfall
		"Tenaglia", --Tenaglia english:Clamp
		"Comete", --Comete english:Swift
		"Capocciata", --Capocciata english:Skull Bash
		...
		"Mangiasogni", --Mangiasogni english:Dream Eater
		"Velenogas", --Velenogas english:Poison Gas
		"Att. Pioggia", --Att. Pioggia english:Barrage
		"Sanguisuga", --Sanguisuga english:Leech Life
		"Demonbacio", --Demonbacio english:Lovely Kiss
		"Aeroattacco", --Aeroattacco english:Sky Attack
		"Trasformaz.", --Trasformaz. english:Transform
		"Bolla", --Bolla english:Bubble
		"Stordipugno", --Stordipugno english:Dizzy Punch
		"Spora", --Spora english:Spore
		"Flash", --Flash english:Flash
		"Psiconda", --Psiconda english:Psywave
		"Splash", --Splash english:Splash
		"Scudo Acido", --Scudo Acido english:Acid Armor
		"Martellata", --Martellata english:Crabhammer
		"Esplosione", --Esplosione english:Explosion
		"Sfuriate", --Sfuriate english:Fury Swipes
		"Ossomerang", --Ossomerang english:Bonemerang
		"Riposo", --Riposo english:Rest
		"Frana", --Frana english:Rock Slide
		"Iperzanna", --Iperzanna english:Hyper Fang
		"Affilatore", --Affilatore english:Sharpen
		"Conversione", --Conversione english:Conversion
		"Tripletta", --Tripletta english:Tri Attack
		"Superzanna", --Superzanna english:Super Fang
		"Lacerazione", --Lacerazione english:Slash
		"Sostituto", --Sostituto english:Substitute
		"Scontro", --Scontro english:Struggle
		"Schizzo", --Schizzo english:Sketch
		"Triplocalcio", --Triplocalcio english:Triple Kick
		"Furto", --Furto english:Thief
		"Ragnatela", --Ragnatela english:Spider Web
		"Leggimente", --Leggimente english:Mind Reader
		"Incubo", --Incubo english:Nightmare
		"Ruotafuoco", --Ruotafuoco english:Flame Wheel
		...
		"Dispetto", --Dispetto english:Spite
		"Polneve", --Polneve english:Powder Snow
		"Protezione", --Protezione english:Protect
		"Pugnorapido", --Pugnorapido english:Mach Punch
		"Visotruce", --Visotruce english:Scary Face
		"Finta", --Finta english:Faint Attack
		"Dolcebacio", --Dolcebacio english:Sweet Kiss
		"Panciamburo", --Panciamburo english:Belly Drum
		"Fangobomba", --Fangobomba english:Sludge Bomb
		"Fangosberla", --Fangosberla english:Mud-Slap
		"Octazooka", --Octazooka english:Octazooka
		"Punte", --Punte english:Spikes
		"Falcecannone", --Falcecannone english:Zap Cannon
		"Preveggenza", --Preveggenza english:Foresight
		"Destinobbl.", --Destinobbl. english:Destiny Bond
		"Ultimocanto", --Ultimocanto english:Perish Song
		"Ventogelato", --Ventogelato english:Icy Wind
		"Individua", --Individua english:Detect
		"Ossoraffica", --Ossoraffica english:Bone Rush
		"Localizza", --Localizza english:Lock-On
		"Oltraggio", --Oltraggio english:Outrage
		"Terrempesta", --Terrempesta english:Sandstorm
		"Gigassorbim.", --Gigassorbim. english:Giga Drain
		"Resistenza", --Resistenza english:Endure
		"Fascino", --Fascino english:Charm
		"Rotolamento", --Rotolamento english:Rollout
		"Falsofinale", --Falsofinale english:False Swipe
		"Bullo", --Bullo english:Swagger
		"Buonlatte", --Buonlatte english:Milk Drink
		"Scintilla", --Scintilla english:Spark
		"Tagliofuria", --Tagliofuria english:Fury Cutter
		"Alacciaio", --Alacciaio english:Steel Wing
		"Malosguardo", --Malosguardo english:Mean Look
		"Attrazione", --Attrazione english:Attract
		"Sonnolalia", --Sonnolalia english:Sleep Talk
		"Rintoccasana", --Rintoccasana english:Heal Bell
		"Ritorno", --Ritorno english:Return
		"Regalino", --Regalino english:Present
		"Frustrazione", --Frustrazione english:Frustration
		"Salvaguardia", --Salvaguardia english:Safeguard
		"Malcomune", --Malcomune english:Pain Split
		"Magifuoco", --Magifuoco english:Sacred Fire
		"Magnitudo", --Magnitudo english:Magnitude
		"Dinamipugno", --Dinamipugno english:DynamicPunch
		"Megacorno", --Megacorno english:Megahorn
		"Dragospiro", --Dragospiro english:DragonBreath
		"Staffetta", --Staffetta english:Baton Pass
		"Ripeti", --Ripeti english:Encore
		"Inseguimento", --Inseguimento english:Pursuit
		"Rapigiro", --Rapigiro english:Rapid Spin
		"Profumino", --Profumino english:Sweet Scent
		"Codacciaio", --Codacciaio english:Iron Tail
		"Ferrartigli", --Ferrartigli english:Metal Claw
		"Vitaltiro", --Vitaltiro english:Vital Throw
		"Mattindoro", --Mattindoro english:Morning Sun
		"Sintesi", --Sintesi english:Synthesis
		"Lucelunare", --Lucelunare english:Moonlight
		"Introforza", --Introforza english:Hidden Power
		"Incrocolpo", --Incrocolpo english:Cross Chop
		"Tornado", --Tornado english:Twister
		"Pioggiadanza", --Pioggiadanza english:Rain Dance
		...
		"Divinazione", --Divinazione english:Future Sight
		"Spaccaroccia", --Spaccaroccia english:Rock Smash
		"Mulinello", --Mulinello english:Whirlpool
		"Picchiaduro", --Picchiaduro english:Beat Up
		"Bruciapelo", --Bruciapelo english:Fake Out
		"Baraonda", --Baraonda english:Uproar
		"Accumulo", --Accumulo english:Stockpile
		"Sfoghenergia", --Sfoghenergia english:Spit Up
		"Introenergia", --Introenergia english:Swallow
		"Ondacalda", --Ondacalda english:Heat Wave
		"Grandine", --Grandine english:Hail
		"Attaccalite", --Attaccalite english:Torment
		"Adulazione", --Adulazione english:Flatter
		"Fuocofatuo", --Fuocofatuo english:Will-O-Wisp
		"Memento", --Memento english:Memento
		"Facciata", --Facciata english:Facade
		"Centripugno", --Centripugno english:Focus Punch
		"Maniereforti", --Maniereforti english:SmellingSalt
		"Sonoqui", --Sonoqui english:Follow Me
		"Naturforza", --Naturforza english:Nature Power
		"Sottocarica", --Sottocarica english:Charge
		"Provocazione", --Provocazione english:Taunt
		"Altruismo", --Altruismo english:Helping Hand
		"Raggiro", --Raggiro english:Trick
		"Giocodiruolo", --Giocodiruolo english:Role Play
		"Desiderio", --Desiderio english:Wish
		"Assistente", --Assistente english:Assist
		"Radicamento", --Radicamento english:Ingrain
		"Troppoforte", --Troppoforte english:Superpower
		"Magivelo", --Magivelo english:Magic Coat
		"Riciclo", --Riciclo english:Recycle
		"Vendetta", --Vendetta english:Revenge
		"Breccia", --Breccia english:Brick Break
		"Sbadiglio", --Sbadiglio english:Yawn
		"Privazione", --Privazione english:Knock Off
		"Rimonta", --Rimonta english:Endeavor
		"Eruzione", --Eruzione english:Eruption
		"Baratto", --Baratto english:Skill Swap
		"Esclusiva", --Esclusiva english:Imprison
		"Rinfrescata", --Rinfrescata english:Refresh
		"Rancore", --Rancore english:Grudge
		"Scippo", --Scippo english:Snatch
		"Forzasegreta", --Forzasegreta english:Secret Power
		"Sub", --Sub english:Dive
		"Sberletese", --Sberletese english:Arm Thrust
		"Camuffamento", --Camuffamento english:Camouflage
		"Codadiluce", --Codadiluce english:Tail Glow
		"Abbagliante", --Abbagliante english:Luster Purge
		"Foschisfera", --Foschisfera english:Mist Ball
		"Danzadipiume", --Danzadipiume english:FeatherDance
		"Strampadanza", --Strampadanza english:Teeter Dance
		"Calciardente", --Calciardente english:Blaze Kick
		"Fangata", --Fangata english:Mud Sport
		"Palla Gelo", --Palla Gelo english:Ice Ball
		"Pugnospine", --Pugnospine english:Needle Arm
		"Pigro", --Pigro english:Slack Off
		"Granvoce", --Granvoce english:Hyper Voice
		"Velenodenti", --Velenodenti english:Poison Fang
		"Tritartigli", --Tritartigli english:Crush Claw
		"Incendio", --Incendio english:Blast Burn
		"Idrocannone", --Idrocannone english:Hydro Cannon
		"Meteorpugno", --Meteorpugno english:Meteor Mash
		"Sgomento", --Sgomento english:Astonish
		"Palla Clima", --Palla Clima english:Weather Ball
		"Aromaterapia", --Aromaterapia english:Aromatherapy
		"Falselacrime", --Falselacrime english:Fake Tears
		"Aerasoio", --Aerasoio english:Air Cutter
		"Vampata", --Vampata english:Overheat
		"Segugio", --Segugio english:Odor Sleuth
		"Rocciotomba", --Rocciotomba english:Rock Tomb
		"Ventargenteo", --Ventargenteo english:Silver Wind
		"Ferrostrido", --Ferrostrido english:Metal Sound
		"Meloderba", --Meloderba english:GrassWhistle
		"Solletico", --Solletico english:Tickle
		"Cosmoforza", --Cosmoforza english:Cosmic Power
		"Zampillo", --Zampillo english:Water Spout
		"Segnoraggio", --Segnoraggio english:Signal Beam
		"Pugnodombra", --Pugnodombra english:Shadow Punch
		"Extrasenso", --Extrasenso english:Extrasensory
		"Stramontante", --Stramontante english:Sky Uppercut
		"Sabbiotomba", --Sabbiotomba english:Sand Tomb
		"Purogelo", --Purogelo english:Sheer Cold
		"Fanghiglia", --Fanghiglia english:Muddy Water
		"Semitraglia", --Semitraglia english:Bullet Seed
		"Aeroassalto", --Aeroassalto english:Aerial Ace
		"Gelolancia", --Gelolancia english:Icicle Spear
		"Ferroscudo", --Ferroscudo english:Iron Defense
		"Blocco", --Blocco english:Block
		"Gridodilotta", --Gridodilotta english:Howl
		"Dragartigli", --Dragartigli english:Dragon Claw
		"Radicalbero", --Radicalbero english:Frenzy Plant
		"Granfisico", --Granfisico english:Bulk Up
		"Rimbalzo", --Rimbalzo english:Bounce
		"Colpodifango", --Colpodifango english:Mud Shot
		"Velenocoda", --Velenocoda english:Poison Tail
		"Supplica", --Supplica english:Covet
		"Locomovolt", --Locomovolt english:Volt Tackle
		"Fogliamagica", --Fogliamagica english:Magical Leaf
		"Docciascudo", --Docciascudo english:Water Sport
		"Calmamente", --Calmamente english:Calm Mind
		"Fendifoglia", --Fendifoglia english:Leaf Blade
		"Dragodanza", --Dragodanza english:Dragon Dance
		"Cadutamassi", --Cadutamassi english:Rock Blast
		"Ondashock", --Ondashock english:Shock Wave
		"Idropulsar", --Idropulsar english:Water Pulse
		"Obbliderio", --Obbliderio english:Doom Desire
		"Psicoslancio", --Psicoslancio english:Psycho Boost
	},
	...
	AbilityNames = {
		"Tanfo", --Tanfo english:Stench
		"Piovischio", --Piovischio english:Drizzle
		...
		"Assorbivolt", --Assorbivolt english:Volt Absorb
		...
		"Ventose", --Ventose english:Suction Cups
		"Prepotenza", --Prepotenza english:Intimidate
		"Pedinombra", --Pedinombra english:Shadow Tag
		"Cartavetro", --Cartavetro english:Rough Skin
		"Magidifesa", --Magidifesa english:Wonder Guard
		"Levitazione", --Levitazione english:Levitate
		"Spargispora", --Spargispora english:Effect Spore
		...
		"Risplendi", --Risplendi english:Illuminate
		"Traccia", --Traccia english:Trace
		"Macroforza", --Macroforza english:Huge Power
		"Velenopunto", --Velenopunto english:Poison Point
		"Fuocodentro", --Fuocodentro english:Inner Focus
		"Magmascudo", --Magmascudo english:Magma Armor
		"Idrovelo", --Idrovelo english:Water Veil
		"Magnetismo", --Magnetismo english:Magnet Pull
		"Antisuono", --Antisuono english:Soundproof
		"Copripioggia", --Copripioggia english:Rain Dish
		"Sabbiafiume", --Sabbiafiume english:Sand Stream
		"Pressione", --Pressione english:Pressure
		"Grassospesso", --Grassospesso english:Thick Fat
		"Sveglialampo", --Sveglialampo english:Early Bird
		"Corpodifuoco", --Corpodifuoco english:Flame Body
		"Fugafacile", --Fugafacile english:Run Away
		"Sguardofermo", --Sguardofermo english:Keen Eye
		"Ipertaglio", --Ipertaglio english:Hyper Cutter
		"Raccolta", --Raccolta english:Pickup
		...
		"Muta", --Muta english:Shed Skin
		"Dentistretti", --Dentistretti english:Guts
		"Pelledura", --Pelledura english:Marvel Scale
		"Melma", --Melma english:Liquid Ooze
		"Erbaiuto", --Erbaiuto english:Overgrow
		"Aiutofuoco", --Aiutofuoco english:Blaze
		...
		"Forzapura", --Forzapura english:Pure Power
		"Guscioscudo", --Guscioscudo english:Shell Armor
		"Cacofonia", --Cacofonia english:Cacophony
		"Riparo", --Riparo english:Air Lock
	},
	-- The list below must remain in the same order.
	...
	ItemNames = {
		...
		"Minor Ball", --Minor Ball english:Nest Ball
		"Bis Ball", --Bis Ball english:Repeat Ball
		"Timer Ball", --Timer Ball english:Timer Ball
		"Chic Ball", --Chic Ball english:Luxury Ball
		"Premier Ball", --Premier Ball english:Premier Ball
		"Pozione", --Pozione english:Potion
		"Antidoto", --Antidoto english:Antidote
		"Antiscottat.", --Antiscottat. english:Burn Heal
		"Antigelo", --Antigelo english:Ice Heal
		"Sveglia", --Sveglia english:Awakening
		"Antiparalisi", --Antiparalisi english:Parlyz Heal
		"Ricarica Tot", --Ricarica Tot english:Full Restore
		"Pozione Max", --Pozione Max english:Max Potion
		"Iperpozione", --Iperpozione english:Hyper Potion
		"Superpozione", --Superpozione english:Super Potion
		"Cura Totale", --Cura Totale english:Full Heal
		"Revitaliz.", --Revitaliz. english:Revive
		"Revital. Max", --Revital. Max english:Max Revive
		"Acqua Fresca", --Acqua Fresca english:Fresh Water
		"Gassosa", --Gassosa english:Soda Pop
		"Lemonsucco", --Lemonsucco english:Lemonade
		"Latte Mumu", --Latte Mumu english:Moomoo Milk
		"Polvenergia", --Polvenergia english:EnergyPowder
		"Radicenergia", --Radicenergia english:Energy Root
		"Polvocura", --Polvocura english:Heal Powder
		"Vitalerba", --Vitalerba english:Revival Herb
		"Etere", --Etere english:Ether
		"Etere Max", --Etere Max english:Max Ether
		"Elisir", --Elisir english:Elixir
		"Elisir Max", --Elisir Max english:Max Elixir
		"Lavottino", --Lavottino english:Lava Cookie
		"Flauto Blu", --Flauto Blu english:Blue Flute
		"Flauto Gial.", --Flauto Gial. english:Yellow Flute
		"Flauto Rosso", --Flauto Rosso english:Red Flute
		"Flauto Nero", --Flauto Nero english:Black Flute
		"Flauto B.nco", --Flauto B.nco english:White Flute
		"Succodibacca", --Succodibacca english:Berry Juice
		"Ceneremagica", --Ceneremagica english:Sacred Ash
		"Sale Ondoso", --Sale Ondoso english:Shoal Salt
		"Gusciondoso", --Gusciondoso english:Shoal Shell
		"Coccio Rosso", --Coccio Rosso english:Red Shard
		"Coccio Blu", --Coccio Blu english:Blue Shard
		"Coccio Gial.", --Coccio Gial. english:Yellow Shard
		"Coccio Verde", --Coccio Verde english:Green Shard
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		...
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"Ps-Su", --Ps-Su english:HP Up
		"Proteina", --Proteina english:Protein
		"Ferro", --Ferro english:Iron
		"Carburante", --Carburante english:Carbos
		"Calcio", --Calcio english:Calcium
		"Caram. Rara", --Caram. Rara english:Rare Candy
		"Pp-Su", --Pp-Su english:PP Up
		"Zinco", --Zinco english:Zinc
		"Pp-Max", --Pp-Max english:PP Max
		"????????", --???????? english:unknown
		"Superguardia", --Superguardia english:Guard Spec.
		...
		"Repell. Max", --Repell. Max english:Max Repel
		"Fune Di Fuga", --Fune Di Fuga english:Escape Rope
		"Repellente", --Repellente english:Repel
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		...
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"Minifungo", --Minifungo english:TinyMushroom
		"Grande Fungo", --Grande Fungo english:Big Mushroom
		"????????", --???????? english:unknown
		"Perla", --Perla english:Pearl
		"Grande Perla", --Grande Perla english:Big Pearl
		"Polvostella", --Polvostella english:Stardust
		"Pezzo Stella", --Pezzo Stella english:Star Piece
		"Pepita", --Pepita english:Nugget
		"Squama Cuore", --Squama Cuore english:Heart Scale
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		...
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"Mess. Agrume", --Mess. Agrume english:Orange Mail
		"Mess. Porto", --Mess. Porto english:Harbor Mail
		"Mess. Luci", --Mess. Luci english:Glitter Mail
		"Mess. Tecno", --Mess. Tecno english:Mech Mail
		"Mess. Bosco", --Mess. Bosco english:Wood Mail
		"Mess. Onda", --Mess. Onda english:Wave Mail
		"Mess. Perle", --Mess. Perle english:Bead Mail
		"Mess. Ombra", --Mess. Ombra english:Shadow Mail
		...
		"Baccafrago", --Baccafrago english:Rawst Berry
		"Baccaperina", --Baccaperina english:Aspear Berry
		"Baccamela", --Baccamela english:Leppa Berry
		"Baccarancia", --Baccarancia english:Oran Berry
		"Baccaki", --Baccaki english:Persim Berry
		"Baccaprugna", --Baccaprugna english:Lum Berry
		"Baccacedro", --Baccacedro english:Sitrus Berry
		"Baccafico", --Baccafico english:Figy Berry
		"Baccakiwi", --Baccakiwi english:Wiki Berry
		"Baccamango", --Baccamango english:Mago Berry
		"Baccaguava", --Baccaguava english:Aguav Berry
		"Baccapaia", --Baccapaia english:Iapapa Berry
		"Baccalampon", --Baccalampon english:Razz Berry
		"Baccamora", --Baccamora english:Bluk Berry
		"Baccabana", --Baccabana english:Nanab Berry
		"Baccapera", --Baccapera english:Wepear Berry
		"Baccananas", --Baccananas english:Pinap Berry
		"Baccagrana", --Baccagrana english:Pomeg Berry
		"Baccalga", --Baccalga english:Kelpsy Berry
		"Baccaloquat", --Baccaloquat english:Qualot Berry
		"Baccamelon", --Baccamelon english:Hondew Berry
		"Baccauva", --Baccauva english:Grepa Berry
		"Baccamodoro", --Baccamodoro english:Tamato Berry
		"Baccavena", --Baccavena english:Cornn Berry
		"Baccagostan", --Baccagostan english:Magost Berry
		"Baccambutan", --Baccambutan english:Rabuta Berry
		"Baccalemon", --Baccalemon english:Nomel Berry
		"Baccamelos", --Baccamelos english:Spelon Berry
		"Baccapalma", --Baccapalma english:Pamtre Berry
		"Baccacomero", --Baccacomero english:Watmel Berry
		"Baccadurian", --Baccadurian english:Durin Berry
		"Baccartillo", --Baccartillo english:Belue Berry
		"Baccalici", --Baccalici english:Liechi Berry
		"Baccalongan", --Baccalongan english:Ganlon Berry
		"Baccasalak", --Baccasalak english:Salac Berry
		"Baccapitaya", --Baccapitaya english:Petaya Berry
		"Baccacocca", --Baccacocca english:Apicot Berry
		"Baccalangsa", --Baccalangsa english:Lansat Berry
		"Baccambola", --Baccambola english:Starf Berry
		"Baccaenigma", --Baccaenigma english:Enigma Berry
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"Luminpolvere", --Luminpolvere english:BrightPowder
		"Erbachiara", --Erbachiara english:White Herb
		"Crescicappa", --Crescicappa english:Macho Brace
		"Condiv. Esp.", --Condiv. Esp. english:Exp. Share
		"Rapidartigli", --Rapidartigli english:Quick Claw
		"Calmanella", --Calmanella english:Soothe Bell
		"Mentalerba", --Mentalerba english:Mental Herb
		"Bendascelta", --Bendascelta english:Choice Band
		"Roccia Di Re", --Roccia Di Re english:King's Rock
		"Argenpolvere", --Argenpolvere english:SilverPowder
		"Monetamuleto", --Monetamuleto english:Amulet Coin
		"Velopuro", --Velopuro english:Cleanse Tag
		"Cuorugiada", --Cuorugiada english:Soul Dew
		"Dente Abissi", --Dente Abissi english:DeepSeaTooth
		"Squamabissi", --Squamabissi english:DeepSeaScale
		"Palla Fumo", --Palla Fumo english:Smoke Ball
		"Pietrastante", --Pietrastante english:Everstone
		"Bandana", --Bandana english:Focus Band
		"Fortunuovo", --Fortunuovo english:Lucky Egg
		"Mirino", --Mirino english:Scope Lens
		"Metalcoperta", --Metalcoperta english:Metal Coat
		"Avanzi", --Avanzi english:Leftovers
		"Squama Drago", --Squama Drago english:Dragon Scale
		"Elettropalla", --Elettropalla english:Light Ball
		"Sabbia Soff.", --Sabbia Soff. english:Soft Sand
		"Pietradura", --Pietradura english:Hard Stone
		"Miracolseme", --Miracolseme english:Miracle Seed
		"Occhialineri", --Occhialineri english:BlackGlasses
		"Cinturanera", --Cinturanera english:Black Belt
		"Calamita", --Calamita english:Magnet
		"Acqua Magica", --Acqua Magica english:Mystic Water
		"Beccaffilato", --Beccaffilato english:Sharp Beak
		"Velenaculeo", --Velenaculeo english:Poison Barb
		"Gelomai", --Gelomai english:NeverMeltIce
		"Spettrotarga", --Spettrotarga english:Spell Tag
		"Cucch. Torto", --Cucch. Torto english:TwistedSpoon
		"Carbonella", --Carbonella english:Charcoal
		"Dentedidrago", --Dentedidrago english:Dragon Fang
		"Sciarpa Seta", --Sciarpa Seta english:Silk Scarf
		"Upgrade", --Upgrade english:Up-Grade
		"Conchinella", --Conchinella english:Shell Bell
		"Marearoma", --Marearoma english:Sea Incense
		"Distraroma", --Distraroma english:Lax Incense
		"Fortunpugno", --Fortunpugno english:Lucky Punch
		"Metalpolvere", --Metalpolvere english:Metal Powder
		"Ossospesso", --Ossospesso english:Thick Club
		"Gambo", --Gambo english:Stick
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		...
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"Fascia Rossa", --Fascia Rossa english:Red Scarf
		"Fascia Blu", --Fascia Blu english:Blue Scarf
		"Fascia Rosa", --Fascia Rosa english:Pink Scarf
		"Fascia Verde", --Fascia Verde english:Green Scarf
		"Fascia Gial.", --Fascia Gial. english:Yellow Scarf
		"Bici Corsa", --Bici Corsa english:Mach Bike
		"Salvadanaio", --Salvadanaio english:Coin Case
		"Detector", --Detector english:Itemfinder
		"Amo Vecchio", --Amo Vecchio english:Old Rod
		"Amo Buono", --Amo Buono english:Good Rod
		"Super Amo", --Super Amo english:Super Rod
		"Bigl. Nave", --Bigl. Nave english:S.S. Ticket
		"Tessera Gare", --Tessera Gare english:Contest Pass
		"????????", --???????? english:unknown
		"Vaso Wailmer", --Vaso Wailmer english:Wailmer Pail
		"Merce Devon", --Merce Devon english:Devon Goods
		...
		"Sfera Blu", --Sfera Blu english:Blue Orb
		"Scanner", --Scanner english:Scanner
		"Occhialoni", --Occhialoni english:Go-Goggles
		"Meteorite", --Meteorite english:Meteorite
		"Chiave Cab.1", --Chiave Cab.1 english:Rm. 1 Key
		"Chiave Cab.2", --Chiave Cab.2 english:Rm. 2 Key
		"Chiave Cab.4", --Chiave Cab.4 english:Rm. 4 Key
		"Chiave Cab.6", --Chiave Cab.6 english:Rm. 6 Key
		"Chiave Stiva", --Chiave Stiva english:Storage Key
		"Radifossile", --Radifossile english:Root Fossil
		"Fossilunghia", --Fossilunghia english:Claw Fossil
		"Devonscopio", --Devonscopio english:Devon Scope
		...
		"Mn01", --Mn01 english:HM01
		"Mn02", --Mn02 english:HM02
		"Mn03", --Mn03 english:HM03
		"Mn04", --Mn04 english:HM04
		"Mn05", --Mn05 english:HM05
		"Mn06", --Mn06 english:HM06
		"Mn07", --Mn07 english:HM07
		"Mn08", --Mn08 english:HM08
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		...
		"Ambra Antica", --Ambra Antica english:Old Amber
		"Apriporta", --Apriporta english:Card Key
		"Chiave Asc.", --Chiave Asc. english:Lift Key
		"Helixfossile", --Helixfossile english:Helix Fossil
		...
		"Rubino", --Rubino english:Ruby
		"Zaffiro", --Zaffiro english:Sapphire
		"Stemma Magma", --Stemma Magma english:Magma Emblem
		"Mappa Stinta", -- Mappa Stinta english:Old Sea Map
	},
