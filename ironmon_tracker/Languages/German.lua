ScreenResources{
	...
	TrackerScreen = {
		...
		PedometerTotal = "Gesamt", --PedometerTotal english:Total
		PedometerReset = "Zurücksetzen", --PedometerReset english:Reset
	...
	StartupScreen = {
		...
		ControlsSwapView = "Tausche angezeigte Pokémon", --ControlsSwapView english:Swap viewed Pokémon
	...
	NavigationMenu = {
		...
		ButtonQuickload = "Schnellladen", --ButtonQuickload english:Quickload
	...
	ExtrasScreen = {
		...
		ButtonEditTime = "Ändern", --ButtonEditTime english:Edit
		ButtonRelocateTime = "Verschieben", --ButtonRelocateTime english:Relocate
		...
		ButtonEstimatePokemonIVs = "Pokémon-IV-Potenzial einschätzen", --ButtonEstimatePokemonIVs english:Estimate Pokémon IV Potential
	...
	GameOptionsScreen = {
		...
		ButtonGameStats = "Spielstatistiken", --ButtonGameStats english:Game Stats
		LabelGameOverCondition = "Game is considered over when", -- NEEDS TRANSLATION
		OptionAutoSwapEnemy = "Automatisch zum Gegner wechseln", --OptionAutoSwapEnemy english:Auto swap to enemy
	...
	ThemeScreen = {
		...
		PromptEnterThemeCode = "Design-Code zum Importieren eingeben (Strg+V zum Einfügen)", --PromptEnterThemeCode english:Enter a theme code string to import (Ctrl+V to paste)
		...
		PromptCopyThemeCode = "Design-Code unten kopieren (Strg+C)", --PromptCopyThemeCode english:Copy the theme code below (Ctrl+C)
