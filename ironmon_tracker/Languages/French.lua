ScreenResources{
	...
	AllScreens = {
		...
		Cancel = "Annuler",
		Preview = "Aperçu",
		Save = "Enregistrer", -- Other options: "Sauvegarder", "Sauver"
		Close = "Fermer",
	...
	TrackerScreen = {
		...
		RandomBallChosen = "Balle choisie aléatoirement", -- Or "Balle choisie au hasard"
		...
		BattleNewEncounter = "Nouv. rencontre", -- Or "Nouvelle rencontre"
		...
		BattleTeam = "Équipe", -- "Équi" works well too
		StatHP = "PV",
		StatATK = "ATQ",
		StatDEF = "DEF",
		StatSPA = "ASP", -- not sure
		StatSPD = "DSP", -- not sure
		StatSPE = "VIT",
		...
		PedometerReset = "Reset", -- Is it fine? Correct word is "Réinitialiser"
	...
	StartupScreen = {
		...
		HeaderControls = "Controles GBA",
		ControlsSwapView = "Échanger le Pokémon vu", -- Unsure
		ControlsQuickload = "Charger nouvelle partie",
		ControlsEraseGameSave = "Effacer données du jeu sauvé",
		PromptChooseAPokemonTitle = "Choisissez un Pokémon",
		PromptChooseAPokemonDesc = "Choisissez un Pokémon à afficher au démarrage",
		PromptChooseAPokemonByAttempt = "Basé sur la tentative #",
	...
	ExtrasScreen = {
		...
		LabelTimer = "Options du chronomètre", -- "chrono" is perfect too
		ButtonEditTime = "Modifier",
		ButtonRelocateTime = "Repositionner", -- translation of relocate is "Déménager", but unsure
		OptionShowRandomBallPicker = "Afficher sélecteur de balle aléa.", -- "Montrer" instead of "Afficher"? "au hasard" or "aléatoire" instead of "aléa."? Missing "le"
		OptionDisplayRepelUsage = "Montrer l'utilisation du repousse", -- unsure
		OptionDisplayPedometer = "Afficher les pas du podomètre", -- or "Afficher le podomètre"
		...
		TimerPauseTip = "(Cliquez sur le chronomètre pour mettre en pause)", -- too long?
	},
	GameOptionsScreen = { -- Were too longs, unsure for most
		...
		OptionRevealRandomizedInfo = "Révéler les infos si randomisé",
	},
	QuickloadScreen = {
	...
	ThemeScreen = {
		...
		LabelDefaultTheme = "Default Theme", -- NEEDS TRANSLATION not affected
		LabelActiveCustomTheme = "Active Theme (Custom)", -- NEEDS TRANSLATION not affected
	...
	UpdateScreen = {
		...
		LabelRelease = "Release notes", -- NEEDS TRANSLATION not affected
