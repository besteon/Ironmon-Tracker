ScreenResources{
	...
	TrackerScreen = {
		...
		RandomBallChosen = "Balle choisie au hasard", -- Or "Balle choisie aléatoirement"
		...
		PromptStepsDesc1 = "Le pédomètre changera de couleur lorsque votre objectif sera atteint.",
	...
	SetupScreen = {
		...
		PokemonIconSetLabel = "Pack d'icônes Pokémon",
