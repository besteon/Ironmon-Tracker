ScreenResources{
	...
	GameOverScreen = {
		...
		ButtonRetryBattle = "Recommencer le combat",
		ButtonRetryBattleConfirm = "Êtes-vous sûr ?",
		ButtonSaveAttempt = "Sauvegarder cette tentative",
		...
		ButtonPrizeCard = "Carte récompense",
	},
	...
	LogOverlay = { -- Log Viewer
		...
		ButtonLevelupMoves = "Attaques par niveau",
		ButtonTMMoves = "Attaques CT",
