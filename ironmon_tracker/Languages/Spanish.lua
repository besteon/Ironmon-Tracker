ScreenResources{
	...
	TrackerScreen = {
		...
		RandomBallChosen = "Bola elegida al azar",
		RandomBallLeft = "Izquierda",
		RandomBallMiddle = "Medio",
		RandomBallRight = "Derecha",
		HealsInBag = "Botiquín",
		BattleNewEncounter = "Nuevo encuentro",
		BattleLastSeen = "Último nivel",
		BattleSeenInTheWild = "Avistado salvaje",
		BattleSeenOnTrainers = "Avistado en entrenadores",
		BattleTeam = "Equipo",
		StatHP = "PS",
		StatATK = "ATQ",
		StatDEF = "DEF",
		...
		EncounterSuperRod = "Supercaña",
		EncounterGoodRod = "Caña Buena",
		EncounterOldRod = "Caña Vieja",
		EncounterSeenPokemon = "Pokémon vistos",
		PromptNoteDesc = "Deja una nota corta para",
		...
		PromptStepsEnterGoal = "¿Cuántos pasos faltan para alcanzar tu meta?",
	},
	StartupScreen = {
		...
		TrackedDataMsgNewGame = "Nuevo juego comenzado.",
		TrackedDataMsgAutoDisabled = "Guardado / carga automática desactivada.",
		TrackedDataMsgError = "Error cargando el archivo.",
		HeaderFavorites = "Pokémon favoritos",
		HeaderControls = "Controles de GBA",
		ControlsSwapView = "Cambiar Pokémon visualizado",
		ControlsQuickload = "Carga rápida de la siguiente ROM",
	...
	NavigationMenu = {
		...
		ButtonExtras = "Extras",
		ButtonQuickload = "Carga Rápida",
		ButtonLanguage = "Idioma",
		ButtonUpdate = "Actualizar",
		ButtonExtensions = "Extensiones",
		ButtonCredits = "Créditos",
		ButtonHelp = "Ayuda",
		CreditsCreatedBy = "Creado por",
		CreditsContributors = "Contribuyentes",
		MessageCheckConsole = "Check the Lua Console for a link to the Tracker's Help Wiki.", -- NEEDS TRANSLATION
	},
	SetupScreen = {
		Title = "Ajustes del Tracker",
		PokemonIconSetLabel = "Juego de íconos de Pokémon",
		PokemonIconSetAuthor = "Agregado Por",
		OptionShowTeamView = "Mostrar Vista de Equipo",
		OptionRightJustifiedNumbers = "Números justificados a la derecha",
		OptionDisableCarousel = "Desactivar carrousel principal",
		OptionTrackPCHeals = "Mostrar curas en CP",
		OptionPCHealsCountDown = "Cuenta decreciente de curas en CP",
		ButtonEditControls = "Controles",
		ButtonManageData = "Administrar Datos",
	...
	ExtrasScreen = {
		...
		ButtonViewLogs = "Registros",
		ButtonTimeMachine = "Máquina del Tiempo",
		ButtonCrashRecovery = "Recuperación de fallos",
		LabelTimer = "Opciones de temporizador",
		ButtonEditTime = "Editar",
		ButtonRelocateTime = "Relocalizar",
		OptionShowRandomBallPicker = "Mostrar bola aleatoria",
		OptionDisplayRepelUsage = "Mostrar uso de repelente",
		OptionDisplayPedometer = "Mostrar podómetro de pasos",
		OptionDisplayPlayTime = "Mostrar tiempo de juego",
		OptionAnimatedPokemonPopout = "Ventana de Pokémon animado",
		ButtonEstimatePokemonIVs = "Estimar potencial de IVs",
		...
		TimerPauseTip = "(Clickear en el temporizador para pausar)",
	},
	GameOptionsScreen = {
		Title = "Opciones de Juego",
		ButtonGameStats = "Estadísticas",
		OptionAutoSwapEnemy = "Auto mostrar enemigo",
		OptionHideStatsUntilSummary = "Esconder información hasta el sumario",
		OptionShowExpBar = "Mostrar barra de experiencia",
		OptionShowPhysicalSpecial = "Mostrar íconos de físico/especial",
		OptionShowMoveEffectiveness = "Mostrar efectividad de ataques",
		OptionCalculateVariableDamage = "Calcular daño variable",
		OptionDetermineFriendship = "Determinar amistad lista",
		OptionCountEnemyPP = "Contar uso de PP enemigo",
		OptionShowLastDamage = "Mostrar cálculos de último daño",
		OptionRevealRandomizedInfo = "Revelar información si es aleatoria",
	},
	QuickloadScreen = {
