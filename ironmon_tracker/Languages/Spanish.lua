ScreenResources{
	GameOverScreenQuotes = {
		-- CENTRAR (Out of the text box)
		"¿Qué pasa, entrenador?", -- CENTRAR
		"¿Qué hará ahora el entrenador?", -- CENTRAR
		"¡Oh! ¡Otro fracaso!", -- CENTRAR
		"Bum!",
		"¡Devastador!", -- CENTRAR
		"¡Eliminado! ¡No tuvo ninguna oportunidad!", -- CENTRAR
		"¿Podrá la estrategia dominar la desventaja de nivel?", -- CENTRAR
		"¡No está en condiciones de luchar!", -- CENTRAR
		"Este combate es entre Pokémon claramente desiguales",
		"El Pokémon vuelve a su Poké Ball",
		"¡Abatido! ¡Fue pan comido!", -- CENTRAR
		"¡Esa ha debido doler!", -- CENTRAR
		"¡Y se acabó el combate!", -- CENTRAR
		"¡Qué giro más inesperado!", -- CENTRAR
		"¡Derrotado al instante!", -- CENTRAR
		"¡Guau! ¡Eso fue arrollador!", -- CENTRAR
		"¡Por fin ha sido derrotado!", -- CENTRAR
		"¡Golpe durísimo!", -- CENTRAR
		"¡Eso fue brutal!", -- CENTRAR
		"¡Justo en el punto débil!", -- CENTRAR
		"¡Eh! ¿¡Qué está haciendo!? ¡Se desploma!", -- CENTRAR
		},
	AllScreens = {
		Pokemon = "Pokémon", 
		Back = "Atrás", 
	...
	StreamConnect = {
		...
		LabelHttpGet = "GET", 
		LabelHttpPost = "POST", 
		WarningSetupImport = "Configuración: Importar código y luego selecciona carpeta.",
	...
	MGBAScreens = {
		...
		QuickloadDesc = "Para usar una nueva run, coloca el archivo necesario en la carpeta [quickload] que la encontrarás en la carpeta GBA Tracker.", 		QuickloadChooseMode = "Choose a mode with", 
		QuickloadMode = "Modo", 
		...
		TrackerLastSeen = "Última vez visto", -- NEEDS TRANSLATION || Can't translaste because interface when load is bugged. Same with the next ones in this section.
