GameResources{
	MoveNames = {
		...
		"Doblebofet" .. Constants.getC("ó") .. "n", --Doblebofetón english:DoubleSlap
		"Pu" .. Constants.getC("ñ") .. "o Cometa", --Puño Cometa english:Comet Punch
		"Megapu" .. Constants.getC("ñ") .. "o", --Megapuño english:Mega Punch
		"D" .. Constants.getC("í") .. "a De Pago", --Día De Pago english:Pay Day
		"Pu" .. Constants.getC("ñ") .. "o Fuego", --Puño Fuego english:Fire Punch
		"Pu" .. Constants.getC("ñ") .. "o Hielo", --Puño Hielo english:Ice Punch
		"Pu" .. Constants.getC("ñ") .. "o Trueno", --Puño Trueno english:ThunderPunch
		"Ara" .. Constants.getC("ñ") .. "azo", --Arañazo english:Scratch
		...
		"L" .. Constants.getC("á") .. "tigo Cepa", --Látigo Cepa english:Vine Whip
		"Pisot" .. Constants.getC("ó") .. "n", --Pisotón english:Stomp
		...
		"Gru" .. Constants.getC("ñ") .. "ido", --Gruñido english:Growl
		"Rugido", --Rugido english:Roar
		"Canto", --Canto english:Sing
		"Supers" .. Constants.getC("ó") .. "nico", --Supersónico english:Supersonic
		"Bomba S" .. Constants.getC("ó") .. "nica", --Bomba Sónica english:SonicBoom
		"Anulaci" .. Constants.getC("ó") .. "n", --Anulación english:Disable
		Constants.getC("Á") .. "cido", --Ácido english:Acid
		...
		"Sumisi" .. Constants.getC("ó") .. "n", --Sumisión english:Submission
		"Patada Baja", --Patada Baja english:Low Kick
		"Contador", --Contador english:Counter
		"Mov. S" .. Constants.getC("í") .. "smico", --Mov. Sísmico english:Seismic Toss
		...
		"Somn" .. Constants.getC("í") .. "fero", --Somnífero english:Sleep Powder
		"Danza P" .. Constants.getC("é") .. "talo", --Danza Pétalo english:Petal Dance
		"Disp. Demora", --Disp. Demora english:String Shot
		"Furia Drag" .. Constants.getC("ó") .. "n", --Furia Dragón english:Dragon Rage
		...
		"T" .. Constants.getC("ó") .. "xico", --Tóxico english:Toxic
		"Confusi" .. Constants.getC("ó") .. "n", --Confusión english:Confusion
		"Ps" .. Constants.getC("í") .. "quico", --Psíquico english:Psychic
		"Hipnosis", --Hipnosis english:Hypnosis
		"Meditaci" .. Constants.getC("ó") .. "n", --Meditación english:Meditate
		"Agilidad", --Agilidad english:Agility
		"At. R" .. Constants.getC("á") .. "pido", --At. Rápido english:Quick Attack
		"Furia", --Furia english:Rage
		"Teletransp", --Teletransp english:Teleport
		"Tinieblas", --Tinieblas english:Night Shade
		"Mim" .. Constants.getC("é") .. "tico", --Mimético english:Mimic
		"Chirrido", --Chirrido english:Screech
		"Doble Equipo", --Doble Equipo english:Double Team
		"Recuperaci" .. Constants.getC("ó") .. "n", --Recuperación english:Recover
		"Fortaleza", --Fortaleza english:Harden
		"Reducci" .. Constants.getC("ó") .. "n", --Reducción english:Minimize
		...
		"Foco Energ" .. Constants.getC("í") .. "a", --Foco Energía english:Focus Energy
		"Venganza", --Venganza english:Bide
		"Metr" .. Constants.getC("ó") .. "nomo", --Metrónomo english:Metronome
		...
		"Leng" .. Constants.getC("ü") .. "etazo", --Lengüetazo english:Lick
		"Poluci" .. Constants.getC("ó") .. "n", --Polución english:Smog
		...
		"Clavo Ca" .. Constants.getC("ñ") .. Constants.getC("ó") .. "n", --Clavo Cañón english:Spike Cannon
		"Restricci" .. Constants.getC("ó") .. "n", --Restricción english:Constrict
		"Amnesia", --Amnesia english:Amnesia
		"Kin" .. Constants.getC("é") .. "tico", --Kinético english:Kinesis
		...
		"Come Sue" .. Constants.getC("ñ") .. "os", --Come Sueños english:Dream Eater
		...
		"Ataque A" .. Constants.getC("é") .. "reo", --Ataque Aéreo english:Sky Attack
		"Transform", --Transform english:Transform
		"Burbuja", --Burbuja english:Bubble
		"Pu" .. Constants.getC("ñ") .. "o Mareo", --Puño Mareo english:Dizzy Punch
		...
		"Armad. " .. Constants.getC("Á") .. "cida", --Armad. Ácida english:Acid Armor
		"Martillazo", --Martillazo english:Crabhammer
		"Explosi" .. Constants.getC("ó") .. "n", --Explosión english:Explosion
		...
		"Conversi" .. Constants.getC("ó") .. "n", --Conversión english:Conversion
		...
		"Ladr" .. Constants.getC("ó") .. "n", --Ladrón english:Thief
		"Telara" .. Constants.getC("ñ") .. "a", --Telaraña english:Spider Web
		"Tel" .. Constants.getC("é") .. "pata", --Telépata english:Mind Reader
		...
		"Protecci" .. Constants.getC("ó") .. "n", --Protección english:Protect
		"Ultrapu" .. Constants.getC("ñ") .. "o", --Ultrapuño english:Mach Punch
		...
		"Bofet" .. Constants.getC("ó") .. "n Lodo", --Bofetón Lodo english:Mud-Slap
		"Pulpoca" .. Constants.getC("ñ") .. Constants.getC("ó") .. "n", --Pulpocañón english:Octazooka
		"P" .. Constants.getC("ú") .. "as", --Púas english:Spikes
		"Electroca" .. Constants.getC("ñ") .. Constants.getC("ó") .. "n", --Electrocañón english:Zap Cannon
		"Profec" .. Constants.getC("í") .. "a", --Profecía english:Foresight
		...
		"Detecci" .. Constants.getC("ó") .. "n", --Detección english:Detect
		"Ataque " .. Constants.getC("Ó") .. "seo", --Ataque Óseo english:Bone Rush
		...
		"Atracci" .. Constants.getC("ó") .. "n", --Atracción english:Attract
		"Son" .. Constants.getC("á") .. "mbulo", --Sonámbulo english:Sleep Talk
		"Campana Cura", --Campana Cura english:Heal Bell
		"Retroceso", --Retroceso english:Return
		"Presente", --Presente english:Present
		"Frustraci" .. Constants.getC("ó") .. "n", --Frustración english:Frustration
		...
		"Pu" .. Constants.getC("ñ") .. "odin" .. Constants.getC("á") .. "mico", --Puñodinámico english:DynamicPunch
		...
		"Persecuci" .. Constants.getC("ó") .. "n", --Persecución english:Pursuit
		"Giro R" .. Constants.getC("á") .. "pido", --Giro Rápido english:Rapid Spin
		"Dulce Aroma", --Dulce Aroma english:Sweet Scent
		"Cola F" .. Constants.getC("é") .. "rrea", --Cola Férrea english:Iron Tail
		...
		"S" .. Constants.getC("í") .. "ntesis", --Síntesis english:Synthesis
		...
		"Cicl" .. Constants.getC("ó") .. "n", --Ciclón english:Twister
		"Danza Lluvia", --Danza Lluvia english:Rain Dance
		"D" .. Constants.getC("í") .. "a Soleado", --Día Soleado english:Sunny Day
		"Triturar", --Triturar english:Crunch
		"Manto Espejo", --Manto Espejo english:Mirror Coat
		"M" .. Constants.getC("á") .. "s Psique", --Más Psique english:Psych Up
		...
		"Premonici" .. Constants.getC("ó") .. "n", --Premonición english:Future Sight
		...
		"Onda " .. Constants.getC("Í") .. "gnea", --Onda Ígnea english:Heat Wave
		...
		"Pu" .. Constants.getC("ñ") .. "o Certero", --Puño Certero english:Focus Punch
		"Est" .. Constants.getC("í") .. "mulo", --Estímulo english:SmellingSalt
		"Se" .. Constants.getC("ñ") .. "uelo", --Señuelo english:Follow Me
		"Adaptaci" .. Constants.getC("ó") .. "n", --Adaptación english:Nature Power
		"Carga", --Carga english:Charge
		"Mofa", --Mofa english:Taunt
		"Refuerzo", --Refuerzo english:Helping Hand
		"Truco", --Truco english:Trick
		"Imitaci" .. Constants.getC("ó") .. "n", --Imitación english:Role Play
		...
		"Capa M" .. Constants.getC("á") .. "gica", --Capa Mágica english:Magic Coat
		"Reciclaje", --Reciclaje english:Recycle
		"Desquite", --Desquite english:Revenge
		"Demolici" .. Constants.getC("ó") .. "n", --Demolición english:Brick Break
		...
		"Da" .. Constants.getC("ñ") .. "o Secreto", --Daño Secreto english:Secret Power
		"Buceo", --Buceo english:Dive
		"Empuj" .. Constants.getC("ó") .. "n", --Empujón english:Arm Thrust
		"Camuflaje", --Camuflaje english:Camouflage
		"R" .. Constants.getC("á") .. "faga", --Ráfaga english:Tail Glow
		...
		"Patada " .. Constants.getC("Í") .. "gnea", --Patada Ígnea english:Blaze Kick
		...
		"Vozarr" .. Constants.getC("ó") .. "n", --Vozarrón english:Hyper Voice
		"Colmillo Ven", --Colmillo Ven english:Poison Fang
		"Garra Brutal", --Garra Brutal english:Crush Claw
		"Anillo " .. Constants.getC("Í") .. "gneo", --Anillo Ígneo english:Blast Burn
		"Hidroca" .. Constants.getC("ñ") .. Constants.getC("ó") .. "n", --Hidrocañón english:Hydro Cannon
		"Pu" .. Constants.getC("ñ") .. "o Meteoro", --Puño Meteoro english:Meteor Mash
		...
		"Eco Met" .. Constants.getC("á") .. "lico", --Eco Metálico english:Metal Sound
		"Silbato", --Silbato english:GrassWhistle
		"Cosquillas", --Cosquillas english:Tickle
		"Masa C" .. Constants.getC("ó") .. "smica", --Masa Cósmica english:Cosmic Power
		"Salpicar", --Salpicar english:Water Spout
		"Doble Rayo", --Doble Rayo english:Signal Beam
		"Pu" .. Constants.getC("ñ") .. "o Sombra", --Puño Sombra english:Shadow Punch
		...
		"Fr" .. Constants.getC("í") .. "o Polar", --Frío Polar english:Sheer Cold
		"Agua Lodosa", --Agua Lodosa english:Muddy Water
		"Recurrente", --Recurrente english:Bullet Seed
		"Golpe A" .. Constants.getC("é") .. "reo", --Golpe Aéreo english:Aerial Ace
		"Car" .. Constants.getC("á") .. "mbano", --Carámbano english:Icicle Spear
		"Def. F" .. Constants.getC("é") .. "rrea", --Def. Férrea english:Iron Defense
		"Bloqueo", --Bloqueo english:Block
		"Aullido", --Aullido english:Howl
		"Garra Drag" .. Constants.getC("ó") .. "n", --Garra Dragón english:Dragon Claw
		...
		"Placaje El" .. Constants.getC("é") .. "c", --Placaje Eléc english:Volt Tackle
		"Hoja M" .. Constants.getC("á") .. "gica", --Hoja Mágica english:Magical Leaf
		...
		"Danza Drag" .. Constants.getC("ó") .. "n", --Danza Dragón english:Dragon Dance
	...
	AbilityNames = {
		...
		"Intimidaci" .. Constants.getC("ó") .. "n", --Intimidación english:Intimidate
		...
		"Levitaci" .. Constants.getC("ó") .. "n", --Levitación english:Levitate
		"Efec. Espora", --Efec. Espora english:Effect Spore
		"Sincron" .. Constants.getC("í") .. "a", --Sincronía english:Synchronize
		...
		"Nado R" .. Constants.getC("á") .. "pido", --Nado Rápido english:Swift Swim
		"Clorofila", --Clorofila english:Chlorophyll
		"Iluminaci" .. Constants.getC("ó") .. "n", --Iluminación english:Illuminate
		"Rastro", --Rastro english:Trace
		"Potencia", --Potencia english:Huge Power
		"Punto T" .. Constants.getC("ó") .. "xico", --Punto Tóxico english:Poison Point
		...
		"Im" .. Constants.getC("á") .. "n", --Imán english:Magnet Pull
		...
		"Presi" .. Constants.getC("ó") .. "n", --Presión english:Pressure
		...
		"M" .. Constants.getC("á") .. "s", --Más english:Plus
		"Menos", --Menos english:Minus
		"Predicci" .. Constants.getC("ó") .. "n", --Predicción english:Forecast
		...
		"Lodo L" .. Constants.getC("í") .. "quido", --Lodo Líquido english:Liquid Ooze
		...
		"Sequ" .. Constants.getC("í") .. "a", --Sequía english:Drought
		"Trampa Arena", --Trampa Arena english:Arena Trap
		"Esp" .. Constants.getC("í") .. "r. Vital", --Espír. Vital english:Vital Spirit
		"Humo Blanco", --Humo Blanco english:White Smoke
		"Energ" .. Constants.getC("í") .. "a Pura", --Energía Pura english:Pure Power
		"Caparaz" .. Constants.getC("ó") .. "n", --Caparazón english:Shell Armor
		"Cacofon" .. Constants.getC("í") .. "a", --Cacofonía english:Cacophony
	...
	ItemNames = {
		...
		"Poci" .. Constants.getC("ó") .. "n", --Poción english:Potion
		"Ant" .. Constants.getC("í") .. "doto", --Antídoto english:Antidote
		...
		"M" .. Constants.getC("á") .. "x. Poci" .. Constants.getC("ó") .. "n", --Máx. Poción english:Max Potion
		"Hiperpoci" .. Constants.getC("ó") .. "n", --Hiperpoción english:Hyper Potion
		"Superpoci" .. Constants.getC("ó") .. "n", --Superpoción english:Super Potion
		"Cura Total", --Cura Total english:Full Heal
		"Revivir", --Revivir english:Revive
		"M" .. Constants.getC("á") .. "x. Revivir", --Máx. Revivir english:Max Revive
		...
		"Polvoenerg" .. Constants.getC("í") .. "a", --Polvoenergía english:EnergyPowder
		"Ra" .. Constants.getC("í") .. "z Energ" .. Constants.getC("í") .. "a", --Raíz Energía english:Energy Root
		"Pol.curaci" .. Constants.getC("ó") .. "n", --Pol.curación english:Heal Powder
		"Hierba Rev.", --Hierba Rev. english:Revival Herb
		Constants.getC("É") .. "ter", --Éter english:Ether
		Constants.getC("É") .. "ter M" .. Constants.getC("á") .. "x.", --Éter Máx. english:Max Ether
		"Elixir", --Elixir english:Elixir
		"Elixir M" .. Constants.getC("á") .. "x.", --Elixir Máx. english:Max Elixir
		...
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"M" .. Constants.getC("á") .. "s Ps", --Más Ps english:HP Up
		"Prote" .. Constants.getC("í") .. "na", --Proteína english:Protein
		...
		"M" .. Constants.getC("á") .. "s Pp", --Más Pp english:PP Up
		"Zinc", --Zinc english:Zinc
		"M" .. Constants.getC("á") .. "x. Pp", --Máx. Pp english:PP Max
		"????????", --???????? english:unknown
		...
		"Precisi" .. Constants.getC("ó") .. "n X", --Precisión X english:X Accuracy
		"Especial X", --Especial X english:X Special
		Constants.Words.POKE .. " Mu" .. Constants.getC("ñ") .. "eco", --Poké Muñeco english:Poke Doll
		"Cola Skitty", --Cola Skitty english:Fluffy Tail
		"????????", --???????? english:unknown
		"Superrepel", --Superrepel english:Super Repel
		"M" .. Constants.getC("á") .. "x. Repel", --Máx. Repel english:Max Repel
		...
		"Esc. Coraz" .. Constants.getC("ó") .. "n", --Esc. Corazón english:Heart Scale
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		...
		"Carta Im" .. Constants.getC("á") .. "n", --Carta Imán english:Mech Mail
		...
		"Carta Sue" .. Constants.getC("ñ") .. "o", --Carta Sueño english:Dream Mail
		...
		"Garra R" .. Constants.getC("á") .. "pida", --Garra Rápida english:Quick Claw
		...
		"Roc" .. Constants.getC("í") .. "o Bondad", --Rocío Bondad english:Soul Dew
		...
		"Rev.met" .. Constants.getC("á") .. "lico", --Rev.metálico english:Metal Coat
		"Restos", --Restos english:Leftovers
		"Escamadrag" .. Constants.getC("ó") .. "n", --Escamadragón english:Dragon Scale
		...
		"Im" .. Constants.getC("á") .. "n", --Imán english:Magnet
		"Agua M" .. Constants.getC("í") .. "stica", --Agua Mística english:Mystic Water
		...
		"Carb" .. Constants.getC("ó") .. "n", --Carbón english:Charcoal
		"Colmillodrag", --Colmillodrag english:Dragon Fang
		"Pa" .. Constants.getC("ñ") .. "uelo Seda", --Pañuelo Seda english:Silk Scarf
		...
		"Pu" .. Constants.getC("ñ") .. "o Suerte", --Puño Suerte english:Lucky Punch
		"Pol.met" .. Constants.getC("á") .. "lico", --Pol.metálico english:Metal Powder
		...
		"????????", --???????? english:unknown
		"????????", --???????? english:unknown
		"Pa" .. Constants.getC("ñ") .. "uelo Rojo", --Pañuelo Rojo english:Red Scarf
		"Pa" .. Constants.getC("ñ") .. "uelo Azul", --Pañuelo Azul english:Blue Scarf
		"Pa" .. Constants.getC("ñ") .. "uelo Rosa", --Pañuelo Rosa english:Pink Scarf
		"Pa" .. Constants.getC("ñ") .. ". Verde", --Pañ. Verde english:Green Scarf
		...
		"Ca" .. Constants.getC("ñ") .. "a Vieja", --Caña Vieja english:Old Rod
		"Ca" .. Constants.getC("ñ") .. "a Buena", --Caña Buena english:Good Rod
		"Superca" .. Constants.getC("ñ") .. "a", --Supercaña english:Super Rod
		...
		"Saco Holl" .. Constants.getC("í") .. "n", --Saco Hollín english:Soot Sack
		"Ll. S" .. Constants.getC("ó") .. "tano", --Ll. Sótano english:Basement Key
		"Bici Acrob.", --Bici Acrob. english:Acro Bike
		"Tubo Pokeblocks", --Tubo Pokeblocks english:Pokeblock Case
		"Carta", --Carta english:Letter
		"Ticket E" .. Constants.getC("ó") .. "n", --Ticket Eón english:Eon Ticket
		"Esfera Roja", --Esfera Roja english:Red Orb
		"Esfera Azul", --Esfera Azul english:Blue Orb
		"Esc" .. Constants.getC("á") .. "ner", --Escáner english:Scanner
		...
		"Ll. Almac" .. Constants.getC("é") .. "n", --Ll. Almacén english:Storage Key
		"F" .. Constants.getC("ó") .. "sil Ra" .. Constants.getC("í") .. "z", --Fósil Raíz english:Root Fossil
		"F" .. Constants.getC("ó") .. "sil Garra", --Fósil Garra english:Claw Fossil
		...
		Constants.Words.POKE .. " Flauta", --Poké Flauta english:Poke Flute
		...
		Constants.getC("Á") .. "mbar Viejo", --Ámbar Viejo english:Old Amber
		"Ll.magn" .. Constants.getC("é") .. "tica", --Ll.magnética english:Card Key
		"Ll. Ascensor", --Ll. Ascensor english:Lift Key
		"F" .. Constants.getC("ó") .. "sil Helix", --Fósil Helix english:Helix Fossil
		"F" .. Constants.getC("ó") .. "sil Domo", --Fósil Domo english:Dome Fossil
		...
		"Rub" .. Constants.getC("í"), --Rubí english:Ruby
