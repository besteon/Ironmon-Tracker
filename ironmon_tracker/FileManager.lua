...
FileManager.Files = {
	...
	GACHAMON_RATINGS = FileManager.Folders.TrackerCode .. FileManager.slash .. FileManager.Folders.GachaMon .. FileManager.slash .. "RatingsCalcData.json",
	GACHAMON_COLLECTION = FileManager.Folders.TrackerCode .. FileManager.slash .. FileManager.Folders.GachaMon .. FileManager.slash .. "GachaMonCollection.json",
	LanguageCode = {
