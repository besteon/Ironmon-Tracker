...
FileManager.Files = {
	...
	LuaCode = {
		"Inifile.lua",
		"Constants.lua",
		FileManager.Folders.DataCode .. FileManager.slash .. "PokemonData.lua",
		FileManager.Folders.DataCode .. FileManager.slash .. "MoveData.lua",
		FileManager.Folders.DataCode .. FileManager.slash .. "AbilityData.lua",
		...
		"ColorPicker.lua",
		"Utils.lua",
		FileManager.Folders.ScreensCode .. FileManager.slash .. "TrackerScreen.lua",
		FileManager.Folders.ScreensCode .. FileManager.slash .. "NavigationMenu.lua",
		FileManager.Folders.ScreensCode .. FileManager.slash .. "StartupScreen.lua",
		FileManager.Folders.ScreensCode .. FileManager.slash .. "UpdateScreen.lua",
		FileManager.Folders.ScreensCode .. FileManager.slash .. "SetupScreen.lua",
		FileManager.Folders.ScreensCode .. FileManager.slash .. "ExtrasScreen.lua",
		FileManager.Folders.ScreensCode .. FileManager.slash .. "QuickloadScreen.lua",
		FileManager.Folders.ScreensCode .. FileManager.slash .. "GameOptionsScreen.lua",
